    ...
    (o.prototype = Object.create(t.prototype)).options = {}, o.prototype.getImages = function() {
        ...
        if (e && c[e]) {
            ...
            if ("string" == typeof this.options.background)
                for (var a = t.querySelectorAll(this.options.background), s = 0; s < a.length; s++) {
                    var o = a[s];
    ...
    function i(l, h, c) {
        (c = c || e || t.jQuery) && (h.prototype.option || (h.prototype.option = function(t) {
            ...
            if ("string" != typeof t) return r = t, this.each(function(t, e) {
                var i = c.data(e, l);
                i ? (i.option(r), i._init()) : (i = new h(e, r), c.data(e, l, i))
            }), this;
            var s, n, a, o, r, e = d.call(arguments, 1);
            return n = e, o = "$()." + l + '("' + (s = t) + '")', (t = this).each(function(t, e) {
                var i = c.data(e, l);
                i ? (e = i[s]) && "_" != s.charAt(0) ? (i = e.apply(i, n), a = void 0 === a ? i : a) : u(o + " is not a valid method") : u(l + " not initialized. Cannot call methods, i.e. " + o)
            }), void 0 !== a ? a : t
        }, s(c))
    }
...
function(t, e) {
    ...
    function m(t) {
        if (y || (y = !0, (u = document.createElement("div")).style.width = "200px", u.style.padding = "1px 2px 3px 4px", u.style.borderStyle = "solid", u.style.borderWidth = "1px 2px 3px 4px", u.style.boxSizing = "border-box", (d = document.body || document.documentElement).appendChild(u), c = f(u), g = 200 == Math.round(p(c.width)), m.isBoxSizeOuter = g, d.removeChild(u)), (t = "string" == typeof t ? document.querySelector(t) : t) && "object" == typeof t && t.nodeType) {
            var e = f(t);
            ...
            var r = i.paddingLeft + i.paddingRight,
                ...
                t = s && g,
                s = p(e.width);
            !1 !== s && (i.width = s + (t ? 0 : r + d));
            s = p(e.height);
            return !1 !== s && (i.height = s + (t ? 0 : l + u)), i.innerWidth = i.width - (r + d), i.innerHeight = i.height - (l + u), i.outerWidth = i.width + h, i.outerHeight = i.height + c, i
        }
        var u, d, c
    }
...
function(t, e) {
    ...
    t.constructor = i, t._create = function() {
        ...
        var t = getComputedStyle(this.element),
            ...
            a = parseFloat(s),
            o = parseFloat(n),
            t = this.layout.size; - 1 != s.indexOf("%") && (a = a / 100 * t.width), -1 != n.indexOf("%") && (o = o / 100 * t.height), a = isNaN(a) ? 0 : a, o = isNaN(o) ? 0 : o, a -= e ? t.paddingLeft : t.paddingRight, o -= i ? t.paddingTop : t.paddingBottom, this.position.x = a, this.position.y = o
        ...
        e[i ? "left" : "right"] = this.getXValue(a), e[n] = "";
...
function(n, a) {
    ...
    function o(t, e) {
        ...
        i ? (this.element = i, h && (this.$element = h(this.element)), this.options = s.extend({}, this.constructor.defaults), this.option(e), e = ++c, this.element.outlayerGUID = e, (d[e] = this)._create(), this._getOption("initLayout") && this.layout()) : l && l.error("Bad element for " + this.constructor.namespace + ": " + (i || t))
    }
    ...
    s.extend(u, e.prototype), u.option = function(t) {
        ...
        delete d[t], delete this.element.outlayerGUID, h && h.removeData(this.element, this.constructor.namespace)
    }, o.data = function(t) {
...
function(t, e) {
    ...
    return t._resetLayout = function() {
        ...
        for (var n = Math.min(this.cols - 1, n), a = (this._getOption("originTop") ? i.top : i.bottom) + e.outerHeight, o = s; o <= n; o++) this.colYs[o] = Math.max(a, this.colYs[o])
...
function(o, r) {
    ...
    n._create = function() {
        ...
        for (var e = this.options.filter, i = [], s = [], n = [], a = this._getFilterTest(e = e || "*"), o = 0; o < t.length; o++) {
            var r, l = t[o];
...
function(t) {
    ...
    var n, o, r, h, c, d, u, p, f, m, g, v, b, y, _, w, C, k, T, E, S, M = "ui-effects-",
        I = "ui-effects-style",
    ...
    function N(s) {
        var n = w(),
            a = n._rgba = [];
        return s = s.toLowerCase(), S(_, function(t, e) {
            var i = e.re.exec(s),
                i = i && e.parse(i),
                e = e.space || "rgba";
    ...
    x.effects = {
    ...
    }, T = w.support = {}, E = g("<p>")[0], S = g.each, E.style.cssText = "background-color:rgba(1,1,1,.5)", T.rgba = -1 < E.style.backgroundColor.indexOf("rgba"), S(C, function(t, e) {
        ...
        parse: function(n, t, e, i) {
            ...
            var a = this,
                s = g.type(n),
                o = this._rgba = [];
            return t !== v && (n = [n, t, e, i], s = "array"), "string" === s ? this.parse(N(n) || b._default) : "array" === s ? (S(C.rgba.props, function(t, e) {
                o[e.idx] = H(n[e.idx], e)
            }), this) : "object" === s ? (S(C, n instanceof w ? function(t, e) {
        ...
        is: function(t) {
            ...
            return S(C, function(t, e) {
                var i, s = n[e.cache];
                return s && (i = o[e.cache] || e.to && e.to(o._rgba) || [], S(e.props, function(t, e) {
        ...
        transition: function(t, o) {
            var e = (h = w(t))._space(),
                i = C[e],
                t = 0 === this.alpha() ? w("transparent") : this,
                r = t[i.cache] || i.to(t._rgba),
                l = r.slice(),
                h = h[i.cache];
            return S(i.props, function(t, e) {
                var i = e.idx,
                    s = r[i],
                    n = h[i],
                    a = k[e.type] || {};
                null !== n && (null === s ? l[i] = n : (a.mod && (n - s > a.mod / 2 ? s += a.mod : s - n > a.mod / 2 && (s -= a.mod)), l[i] = H((n - s) * o + s, e)))
            }), this[e](l)
        },
        blend: function(t) {
        ...
        w.fn[r] = function(t) {
            ...
            w.fn[a] || (w.fn[a] = function(t) {
                var e = g.type(t),
                    i = "alpha" === a ? this._hsla ? "hsla" : "rgba" : r,
                    s = this[i](),
                    n = s[o.idx];
        ...
        expand: function(i) {
            var s = {};
            return S(["Top", "Right", "Bottom", "Left"], function(t, e) {
                s["border" + e + "Color"] = i
            }), s
        }
    }, b = g.Color.names = {
        ...
        removeClass: (u = x.fn.removeClass, function(t, e, i, s) {
            return 1 < arguments.length ? x.effects.animateClass.call(this, {
                remove: t
            }, e, i, s) : u.apply(this, arguments)
        }),
        toggleClass: (d = x.fn.toggleClass, function(t, e, i, s, n) {
            return "boolean" == typeof e || void 0 === e ? i ? x.effects.animateClass.call(this, e ? {
                add: t
            } : {
                remove: t
            }, i, s, n) : d.apply(this, arguments) : x.effects.animateClass.call(this, {
                toggle: t
            }, e, i, s)
        }),
    ...
    }), x.expr && x.expr.filters && x.expr.filters.animated && (x.expr.filters.animated = (c = x.expr.filters.animated, function(t) {
        return !!x(t).data(D) || c(t)
        ...
        effect: function() {
            function t(t) {
                ...
                s.mode = h.shift(), !1 === x.uiBackCompat || a ? "none" === s.mode ? (i[l](), e()) : n.call(i[0], s, function() {
                    i.removeData(D), x.effects.cleanUp(i), "hide" === s.mode && i.hide(), e()
                }) : (i.is(":hidden") ? "hide" === l : "show" === l) ? (i[l](), e()) : n.call(i[0], s, e)
            }

            function e(t) {
                var e = x(this),
                    i = x.effects.mode(e, l) || a;
                e.data(D, !0), h.push(i), a && ("show" === i || i === a && "hide" === i) && e.show(), a && "none" === i || x.effects.saveStyle(e), x.isFunction(t) && t()
            }
    ...
    x.effects.define("blind", "hide", function(t, e) {
        ...
        var i, s, n = x(this),
            ...
            m = 0,
            t = n.queue().length;
        for (x.effects.createPlaceholder(n), l = n.css(p), h = h || n["top" == p ? "outerHeight" : "outerWidth"]() / 3, r && ((s = {
                opacity: 1
            })[p] = l, n.css("opacity", 0).css(p, f ? 2 * -h : 2 * h).animate(s, d, u)), o && (h /= Math.pow(2, c - 1)), (s = {})[p] = l; m < c; m++)(i = {})[p] = (f ? "-=" : "+=") + h, n.animate(i, d, u).animate(s, d, u), h = o ? 2 * h : h / 2;
        o && ((i = {
            opacity: 0
        })[p] = (f ? "-=" : "+=") + h, n.animate(i, d, u)), n.queue(e), x.effects.unshift(n, t, 1 + a)
        ...
        for (var s, n, a, o, r, l = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, h = l, c = x(this), d = "show" === t.mode, u = c.show().css("visibility", "hidden").offset(), p = Math.ceil(c.outerWidth() / h), f = Math.ceil(c.outerHeight() / l), m = [], g = 0; g < l; g++)
            for (a = u.top + g * f, r = g - (l - 1) / 2, s = 0; s < h; s++) n = u.left + s * p, o = s - (h - 1) / 2, c.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: -s * p,
                top: -g * f
        ...
        var i = x(this),
            ...
            f = [d[l[0]], d[l[1]]],
            s = i.queue().length;
        r && (o = parseInt(r[1], 10) / 100 * f[a ? 0 : 1]), u.clip[l[0]] = o, p.clip[l[0]] = o, p.clip[l[1]] = 0, n && (i.cssClip(p.clip), c && c.css(x.effects.clipToBox(p)), p.clip = d), i.queue(function(t) {
            c && c.animate(x.effects.clipToBox(u), h, e.easing).animate(x.effects.clipToBox(p), h, e.easing), t()
        }).animate(u, h, e.easing).animate(p, h, e.easing).queue(t), x.effects.unshift(i, s, 4)
        ...
        x.effects.createPlaceholder(i), "show" === r && (r = f, f = m, m = r), n = {
        ...
        }, "box" !== h && "both" !== h || (n.from.y !== n.to.y && (f = x.effects.setTransition(i, a, n.from.y, f), m = x.effects.setTransition(i, a, n.to.y, m)), n.from.x !== n.to.x && (f = x.effects.setTransition(i, o, n.from.x, f), m = x.effects.setTransition(i, o, n.to.x, m))), "content" !== h && "both" !== h || n.from.y === n.to.y || (f = x.effects.setTransition(i, t, n.from.y, f), m = x.effects.setTransition(i, t, n.to.y, m)), c && (c = x.effects.getBaseline(c, p), f.top = (p.outerHeight - f.outerHeight) * c.y + u.top, f.left = (p.outerWidth - f.outerWidth) * c.x + u.left, m.top = (p.outerHeight - m.outerHeight) * c.y + u.top, m.left = (p.outerWidth - m.outerWidth) * c.x + u.left), i.css(f), "content" !== h && "both" !== h || (a = a.concat(["marginTop", "marginBottom"]).concat(t), o = o.concat(["marginLeft", "marginRight"]), i.find("*[width]").each(function() {
            var t = x(this),
            ...
            complete: function() {
                var t = i.offset();
                0 === m.opacity && i.css("opacity", f.opacity), l || (i.css("position", "static" === d ? "relative" : d).offset(t), x.effects.saveStyle(i)), e()
            }
        })
        ...
        var i = 1,
            ...
            p = {},
            n = s.queue().length;
        for (x.effects.createPlaceholder(s), d[h] = (c ? "-=" : "+=") + a, u[h] = (c ? "+=" : "-=") + 2 * a, p[h] = (c ? "-=" : "+=") + 2 * a, s.animate(d, l, t.easing); i < o; i++) s.animate(u, l, t.easing).animate(p, l, t.easing);
        s.animate(u, l, t.easing).animate(d, l / 2, t.easing).queue(e), x.effects.unshift(s, n, 1 + r)
        ...
        var i, s, n = x(this),
            ...
            d = {};
        x.effects.createPlaceholder(n), i = n.cssClip(), s = n.position()[l], d[l] = (h ? -1 : 1) * c + s, d.clip = n.cssClip(), d.clip[a[r][1]] = d.clip[a[r][0]], "show" === o && (n.cssClip(d.clip), n.css(l, d[l]), d.clip = i, d[l] = s), n.animate(d, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: e
    ...
    }, B = Math.max, Y = Math.abs, $ = /left|center|right/, j = /top|center|bottom/, q = /[\+\-]\d+(\.[\d]+)?%?/, X = /^\w+/, V = /%$/, G = x.fn.position, x.position = {
        ...
        d = x.extend({}, d);
        var u, p, f, m, g, t, v = x(d.of),
            b = x.position.getWithinInfo(d.within),
            y = x.position.getScrollInfo(b),
        ...
        return v[0].preventDefault && (d.at = "left top"), p = e.width, f = e.height, g = x.extend({}, m = e.offset), x.each(["my", "at"], function() {
            var t, e, i = (d[this] || "").split(" ");
            (i = 1 === i.length ? $.test(i[0]) ? i.concat(["center"]) : j.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = $.test(i[0]) ? i[0] : "center", i[1] = j.test(i[1]) ? i[1] : "center", t = q.exec(i[0]), e = q.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], d[this] = [X.exec(i[0])[0], X.exec(i[1])[0]]
        }), 1 === _.length && (_[1] = _[0]), "right" === d.at[0] ? g.left += p : "center" === d.at[0] && (g.left += p / 2), "bottom" === d.at[1] ? g.top += f : "center" === d.at[1] && (g.top += f / 2), u = K(w.at, p, f), g.left += u[0], g.top += u[1], this.each(function() {
            var i, t, o = x(this),
                r = o.outerWidth(),
                l = o.outerHeight(),
                e = Q(this, "marginLeft"),
                s = Q(this, "marginTop"),
                n = r + e + Q(this, "marginRight") + y.width,
                a = l + s + Q(this, "marginBottom") + y.height,
                h = x.extend({}, g),
                c = K(w.my, o.outerWidth(), o.outerHeight());
            "right" === d.my[0] ? h.left -= r : "center" === d.my[0] && (h.left -= r / 2), "bottom" === d.my[1] ? h.top -= l : "center" === d.my[1] && (h.top -= l / 2), h.left += c[0], h.top += c[1], i = {
                ...
                p < r && p > Y(e + i) && (a.horizontal = "center"), f < l && f > Y(s + n) && (a.vertical = "middle"), a.important = B(Y(e), Y(i)) > B(Y(s), Y(n)) ? "horizontal" : "vertical", d.using.call(this, t, a)
            }), o.offset(x.extend(h, {
                using: t
            }))
        })
        ...
        flip: {
            left: function(t, e) {
                var i = e.within,
                    ...
                    o = -2 * e.offset[0];
                r < 0 ? ((s = t.left + h + i + o + e.collisionWidth - n - s) < 0 || Y(r) > s) && (t.left += h + i + o) : 0 < l && ((0 < (a = t.left - e.collisionPosition.marginLeft + h + i + o - a) || l > Y(a)) && (t.left += h + i + o))
            },
            top: function(t, e) {
                var i = e.within,
                    ...
                    o = -2 * e.offset[1];
                r < 0 ? ((s = t.top + h + i + o + e.collisionHeight - n - s) < 0 || Y(r) > s) && (t.top += h + i + o) : 0 < l && ((0 < (a = t.top - e.collisionPosition.marginTop + h + i + o - a) || l > Y(a)) && (t.top += h + i + o))
            }
        },
        flipfit: {
            left: function() {
    ...
    x.cleanData = (Z = x.cleanData, function(t) {
        ...
        for (var e, i, s = tt.call(arguments, 1), n = 0, a = s.length; n < a; n++)
            for (e in s[n]) i = s[n][e], s[n].hasOwnProperty(e) && void 0 !== i && (t[e] = x.isPlainObject(i) ? x.isPlainObject(t[e]) ? x.widget.extend({}, t[e], i) : x.widget.extend({}, i) : i);
        return t
    }, x.widget.bridge = function(a, e) {
        var o = e.prototype.widgetFullName || a;
        x.fn[a] = function(i) {
            var t = "string" == typeof i,
                s = tt.call(arguments, 1),
                n = this;
        ...
        x.Widget.prototype["_" + a] = function(e, t, i) {
            var s = (t = "string" == typeof t ? {
                ...
                n = !x.isEmptyObject(t = "number" == typeof(t = t || {}) ? {
                    duration: t
                } : t);
            t.complete = i, t.delay && e.delay(t.delay), n && x.effects && x.effects.effect[s] ? e[a](t) : s !== a && e[s] ? e[s](t.duration, t.easing, i) : e.queue(function(t) {
        ...
        _animate: function(t, i, e) {
            var s, n = this,
                ...
                d = (d = "number" == typeof h ? h : d) || h.duration || l.duration;
            ...
            })) : i.animate(this.hideProps, d, c, r) : t.animate(this.showProps, d, c, r)
        },
        ...
        _keydown: function(t) {
            ...
            switch (t.keyCode) {
                ...
                case x.ui.keyCode.ESCAPE:
                    ...
                    break;
                default:
                    e = this.previousFilter || "", s = n = !1, i = 96 <= t.keyCode && t.keyCode <= 105 ? "" + (t.keyCode - 96) : String.fromCharCode(t.keyCode), clearTimeout(this.filterTimer), i === e ? s = !0 : i = e + i, e = this._filterMenuItems(i), (e = s && -1 !== e.index(this.active.next()) ? this.active.nextAll(".ui-menu-item") : e).length || (i = String.fromCharCode(t.keyCode), e = this._filterMenuItems(i)), e.length ? (this.focus(t, e), this.previousFilter = i, this.filterTimer = this._delay(function() {
        ...
        _create: function() {
            var i, s, n, t = this.element[0].nodeName.toLowerCase(),
                e = "textarea" === t,
                t = "input" === t;
            this.isMultiLine = e || !t && this._isContentEditable(this.element), this.valueMethod = this.element[e || t ? "val" : "text"], this.isNewMenu = !0, this._addClass("ui-autocomplete-input"), this.element.attr("autocomplete", "on"), this._on(this.element, {
                keydown: function(t) {
                ...
                menufocus: function(t, e) {
                    ...
                    return this.isNewMenu && (this.isNewMenu = !1, t.originalEvent && /^mouse/.test(t.originalEvent.type)) ? (this.menu.blur(), void this.document.one("mousemove", function() {
                        ...
                        item: i
                    }) && t.originalEvent && /^key/.test(t.originalEvent.type) && this._value(i.value), void((i = e.item.attr("aria-label") || i.value) && x.trim(i).length && (this.liveRegion.children().hide(), x("<div>").text(i).appendTo(this.liveRegion))))
                },
    ...
    x.widget("ui.controlgroup", {
        ...
        _autoSize: function(t) {
            var e, i, s, n, a, o;
            this._get(t, "autoSize") && !t.inline && (a = new Date(2009, 11, 20), (o = this._get(t, "dateFormat")).match(/[DM]/) && (a.setMonth((e = function(t) {
                for (n = s = i = 0; t.length > n; n++) t[n].length > i && (i = t[n].length, s = n);
                return s
            })(this._get(t, o.match(/MM/) ? "monthNames" : "monthNamesShort"))), a.setDate(e(this._get(t, o.match(/DD/) ? "dayNames" : "dayNamesShort")) + 20 - a.getDay())), t.input.attr("size", this._formatDate(t, a).length))
        },
        ...
        parseDate: function(e, n, t) {
            ...
            function s(t, e, i) {
                ...
                if (x.each(e, function(t, e) {
                        var i = e[1];
                        return n.substr(c, i.length).toLowerCase() === i.toLowerCase() ? (s = e[0], c += i.length, !1) : void 0
                    }), -1 !== s) return s + 1;
            ...
            for (var r, l, h, c = 0, d = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff, d = "string" != typeof d ? d : (new Date).getFullYear() % 100 + parseInt(d, 10), u = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, p = (t ? t.dayNames : null) || this._defaults.dayNames, f = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, m = (t ? t.monthNames : null) || this._defaults.monthNames, g = -1, v = -1, b = -1, y = -1, _ = !1, w = 0; e.length > w; w++)
                if (_) "'" !== e.charAt(w) || a("'") ? o() : _ = !1;
            ...
            if (n.length > c && (l = n.substr(c), !/^\s+/.test(l))) throw "Extra/unparsed characters found in date: " + l;
            if (-1 === g ? g = (new Date).getFullYear() : g < 100 && (g += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (g <= d ? 0 : -100)), -1 < y)
                for (v = 1, b = y; !(b <= (r = this._getDaysInMonth(g, v - 1)));) v++, b -= r;
        ...
        formatDate: function(e, t, i) {
            ...
            if (t)
                for (o = 0; e.length > o; o++)
                    if (u) "'" !== e.charAt(o) || n("'") ? d += e.charAt(o) : u = !1;
        ...
        _possibleChars: function(e) {
            ...
            for (var i = "", s = !1, n = 0; e.length > n; n++)
        ...
        _generateHTML: function(t) {
            var e, i, s, n, a, o, r, l, h, c, d, u, p, f, m, g, v, b, y, _, w, x, C, k, T, E, S, M, I, D, P, z, O = new Date,
                ...
                X = t.drawYear;
            if (q < 0 && (q += 12, X--), j)
                for (e = this._daylightSavingAdjust(new Date(j.getFullYear(), j.getMonth() - F[0] * F[1] + 1, j.getDate())), e = $ && e < $ ? $ : e; this._daylightSavingAdjust(new Date(X, q, 1)) > e;) --q < 0 && (q = 11, X--);
            for (t.drawMonth = q, t.drawYear = X, R = this._get(t, "prevText"), R = W ? this.formatDate(R, this._daylightSavingAdjust(new Date(X, q - O, 1)), this._getFormatConfig(t)) : R, i = this._canAdjustMonth(t, -1, X, q) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + R + "'><span class='ui-icon ui-icon-circle-triangle-" + (A ? "e" : "w") + "'>" + R + "</span></a>" : N ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + R + "'><span class='ui-icon ui-icon-circle-triangle-" + (A ? "e" : "w") + "'>" + R + "</span></a>", R = this._get(t, "nextText"), R = W ? this.formatDate(R, this._daylightSavingAdjust(new Date(X, q + O, 1)), this._getFormatConfig(t)) : R, s = this._canAdjustMonth(t, 1, X, q) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + R + "'><span class='ui-icon ui-icon-circle-triangle-" + (A ? "w" : "e") + "'>" + R + "</span></a>" : N ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + R + "'><span class='ui-icon ui-icon-circle-triangle-" + (A ? "w" : "e") + "'>" + R + "</span></a>", N = this._get(t, "currentText"), R = this._get(t, "gotoCurrent") && t.currentDay ? Y : L, N = W ? this.formatDate(N, R, this._getFormatConfig(t)) : N, W = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", W = H ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (A ? W : "") + (this._isInRange(t, R) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + N + "</button>" : "") + (A ? "" : W) + "</div>" : "", n = parseInt(this._get(t, "firstDay"), 10), n = isNaN(n) ? 0 : n, a = this._get(t, "showWeek"), o = this._get(t, "dayNames"), r = this._get(t, "dayNamesMin"), l = this._get(t, "monthNames"), h = this._get(t, "monthNamesShort"), c = this._get(t, "beforeShowDay"), d = this._get(t, "showOtherMonths"), u = this._get(t, "selectOtherMonths"), p = this._getDefaultDate(t), f = "", g = 0; F[0] > g; g++) {
                for (v = "", this.maxRows = 4, b = 0; F[1] > b; b++) {
                    if (y = this._daylightSavingAdjust(new Date(X, q, t.selectedDay)), _ = " ui-corner-all", w = "", B) {
                    ...
                    for (w += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + _ + "'>" + (/all|left/.test(_) && 0 === g ? A ? s : i : "") + (/all|right/.test(_) && 0 === g ? A ? i : s : "") + this._generateMonthYearHeader(t, q, X, $, j, 0 < g || 0 < b, l, h) + "</div><table class='ui-datepicker-calendar'><thead><tr>", x = a ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", m = 0; m < 7; m++) x += "<th scope='col'" + (5 <= (m + n + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + o[C = (m + n) % 7] + "'>" + r[C] + "</span></th>";
                    for (w += x + "</tr></thead><tbody>", T = this._getDaysInMonth(X, q), X === t.selectedYear && q === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, T)), k = (this._getFirstDayOfMonth(X, q) - n + 7) % 7, T = Math.ceil((k + T) / 7), E = B && this.maxRows > T ? this.maxRows : T, this.maxRows = E, S = this._daylightSavingAdjust(new Date(X, q, 1 - k)), M = 0; M < E; M++) {
                        for (w += "<tr>", I = a ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(S) + "</td>" : "", m = 0; m < 7; m++) D = c ? c.apply(t.input ? t.input[0] : null, [S]) : [!0, ""], z = (P = S.getMonth() !== q) && !u || !D[0] || $ && S < $ || j && j < S, I += "<td class='" + (5 <= (m + n + 6) % 7 ? " ui-datepicker-week-end" : "") + (P ? " ui-datepicker-other-month" : "") + (S.getTime() === y.getTime() && q === t.selectedMonth && t._keyEvent || p.getTime() === S.getTime() && p.getTime() === y.getTime() ? " " + this._dayOverClass : "") + (z ? " " + this._unselectableClass + " ui-state-disabled" : "") + (P && !d ? "" : " " + D[1] + (S.getTime() === Y.getTime() ? " " + this._currentClass : "") + (S.getTime() === L.getTime() ? " ui-datepicker-today" : "")) + "'" + (P && !d || !D[2] ? "" : " title='" + D[2].replace(/'/g, "&#39;") + "'") + (z ? "" : " data-handler='selectDay' data-event='click' data-month='" + S.getMonth() + "' data-year='" + S.getFullYear() + "'") + ">" + (P && !d ? "&#xa0;" : z ? "<span class='ui-state-default'>" + S.getDate() + "</span>" : "<a class='ui-state-default" + (S.getTime() === L.getTime() ? " ui-state-highlight" : "") + (S.getTime() === Y.getTime() ? " ui-state-active" : "") + (P ? " ui-priority-secondary" : "") + "' href='#'>" + S.getDate() + "</a>") + "</td>", S.setDate(S.getDate() + 1), S = this._daylightSavingAdjust(S);
                        w += I + "</tr>"
                    }
                    11 < ++q && (q = 0, X++), v += w += "</tbody></table>" + (B ? "</div>" + (0 < F[0] && b === F[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                f += v
            }
        ...
        _generateMonthYearHeader: function(t, e, i, s, n, a, o, r) {
            var l, h, c, d, u, p, f, m = this._get(t, "changeMonth"),
            ...
            if (v || (b += y + (!a && m && g ? "" : "&#xa0;")), !t.yearshtml)
                if (t.yearshtml = "", a || !g) b += "<span class='ui-datepicker-year'>" + i + "</span>";
                else {
                    for (d = this._get(t, "yearRange").split(":"), u = (new Date).getFullYear(), p = (o = function(t) {
                            t = t.match(/c[+\-].*/) ? i + parseInt(t.substring(1), 10) : t.match(/[+\-].*/) ? u + parseInt(t, 10) : parseInt(t, 10);
                            return isNaN(t) ? u : t
                        })(d[0]), f = Math.max(p, o(d[1] || "")), p = s ? Math.max(p, s.getFullYear()) : p, f = n ? Math.min(f, n.getFullYear()) : f, t.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; p <= f; p++) t.yearshtml += "<option value='" + p + "'" + (p === i ? " selected='selected'" : "") + ">" + p + "</option>";
    ...
    x(document).on("mouseup", function() {
        ...
        drag: function(t, e, i) {
            for (var s, n, a, o, r, l, h, c, d, u = i.options, p = u.snapTolerance, f = e.offset.left, m = f + i.helperProportions.width, g = e.offset.top, v = g + i.helperProportions.height, b = i.snapElements.length - 1; 0 <= b; b--) l = (r = i.snapElements[b].left - i.margins.left) + i.snapElements[b].width, c = (h = i.snapElements[b].top - i.margins.top) + i.snapElements[b].height, m < r - p || l + p < f || v < h - p || c + p < g || !x.contains(i.snapElements[b].item.ownerDocument, i.snapElements[b].item) ? (i.snapElements[b].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, x.extend(i._uiHash(), {
                ...
                top: 0,
                left: l
            }).left)), d = s || n || a || o, "outer" !== u.snapMode && (s = p >= Math.abs(h - g), n = p >= Math.abs(c - v), a = p >= Math.abs(r - f), o = p >= Math.abs(l - m), s && (e.position.top = i._convertPositionTo("relative", {
                top: h,
                left: 0
            }).top), n && (e.position.top = i._convertPositionTo("relative", {
            ...
            }).left)), !i.snapElements[b].snapping && (s || n || a || o || d) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, x.extend(i._uiHash(), {
                snapItem: i.snapElements[b].item
        ...
        _setupHandles: function() {
            ...
            if (this.handles = a.handles || (x(".ui-resizable-handle", this.element).length ? {
                ...
                for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), i = this.handles.split(","), this.handles = {}, e = 0; i.length > e; e++) s = "ui-resizable-" + (t = x.trim(i[e])), n = x("<div>"), this._addClass(n, "ui-resizable-handle " + s), n.css({
                    zIndex: a.zIndex
        ...
        _drop: function(e, t) {
            ...
            return !(!i || (i.currentItem || i.element)[0] === this.element[0]) && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function() {
                ...
                return t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && ot(i, x.extend(t, {
    ...
    function rt(t, e, i) {
        ...
        _refreshValue: function() {
            ...
            this._hasMultipleValues() ? this.handles.each(function(t) {
                i = (r.values(t) - r._valueMin()) / (r._valueMax() - r._valueMin()) * 100, h["horizontal" === r.orientation ? "left" : "bottom"] = i + "%", x(this).stop(1, 1)[l ? "animate" : "css"](h, o.animate), !0 === r.options.range && ("horizontal" === r.orientation ? (0 === t && r.range.stop(1, 1)[l ? "animate" : "css"]({
                    left: i + "%"
            ...
            }) : (t = this.value(), s = this._valueMin(), n = this._valueMax(), h["horizontal" === this.orientation ? "left" : "bottom"] = (i = n !== s ? (t - s) / (n - s) * 100 : 0) + "%", this.handle.stop(1, 1)[l ? "animate" : "css"](h, o.animate), "min" === a && "horizontal" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({
                width: i + "%"
        ...
        _intersectsWith: function(t) {
            var e = this.positionAbs.left,
                ...
                c = "y" === this.options.axis || a < e + c && e + c < o;
        ...
        _getItemsAsjQuery: function(t) {
            ...
            if (l && t)
                for (i = l.length - 1; 0 <= i; i--)
                    for (s = (n = x(l[i], this.document[0])).length - 1; 0 <= s; s--)(a = x.data(n[s], this.widgetFullName)) && a !== this && !a.options.disabled && r.push([x.isFunction(a.options.items) ? a.options.items.call(a.element) : x(a.options.items, a.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), a]);
        ...
        _refreshItems: function(t) {
            ...
            if (d && this.ready)
                for (e = d.length - 1; 0 <= e; e--)
                    for (i = (s = x(d[e], this.document[0])).length - 1; 0 <= i; i--)(n = x.data(s[i], this.widgetFullName)) && n !== this && !n.options.disabled && (c.push([x.isFunction(n.options.items) ? n.options.items.call(n.element[0], t, {
                        item: this.currentItem
                    }) : x(n.options.items, n.element), n]), this.containers.push(n));
            for (e = c.length - 1; 0 <= e; e--)
                for (a = c[e][1], l = (o = c[e][i = 0]).length; i < l; i++)(r = x(o[i])).data(this.widgetName + "-item", a), h.push({
                    item: r,
                    instance: a,
                    width: 0,
                    height: 0,
        ...
        _contactContainers: function(t) {
            for (var e, i, s, n, a, o, r, l, h, c = null, d = null, u = this.containers.length - 1; 0 <= u; u--)
                if (!x.contains(this.currentItem[0], this.containers[u].element[0]))
                    if (this._intersectsWith(this.containers[u].containerCache)) {
                        if (c && x.contains(this.containers[u].element[0], c.element[0])) continue;
            ...
            if (c)
                if (1 === this.containers.length) this.containers[d].containerCache.over || (this.containers[d]._trigger("over", t, this._uiHash(this)), this.containers[d].containerCache.over = 1);
                    ...
                    for (i = 1e4, s = null, n = (l = c.floating || this._isFloating(this.currentItem)) ? "left" : "top", a = l ? "width" : "height", h = l ? "pageX" : "pageY", e = this.items.length - 1; 0 <= e; e--) x.contains(this.containers[d].element[0], this.items[e].item[0]) && this.items[e].item[0] !== this.currentItem[0] && (o = this.items[e].item.offset()[n], r = !1, t[h] - o > this.items[e][a] / 2 && (r = !0), i > Math.abs(t[h] - o) && (i = Math.abs(t[h] - o), s = this.items[e], this.direction = r ? "up" : "down"));
        ...
        _processTabs: function() {
            ...
            this.tablist = this._getList().attr("role", "tablist"), this._addClass(this.tablist, "ui-tabs-nav", "ui-helper-reset ui-helper-clearfix ui-widget-header"), this.tablist.on("mousedown" + this.eventNamespace, "> li", function(t) {
                ...
                l._isLocal(e) ? (n = (i = e.hash).substring(1), s = l.element.find(l._sanitizeSelector(i))) : (n = o.attr("aria-controls") || x({}).uniqueId()[0].id, (s = l.element.find(i = "#" + n)).length || (s = l._createPanel(n)).insertAfter(l.panels[t - 1] || l.tablist), s.attr("aria-live", "polite")), s.length && (l.panels = l.panels.add(s)), r && o.data("ui-tabs-aria-controls", r), o.attr({
                    "aria-controls": n,
                    "aria-labelledby": a
...
function(e) {
    ...
    e.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            var u = e(this),
                p = {
                    time: e(this).data("counterup-time") || m.time,
                    delay: e(this).data("counterup-delay") || m.delay
                };
            u.waypoint(function(t) {
                ! function() {
                    var t = [],
                        ...
                        s = /[0-9]+,[0-9]+/.test(i),
                        n = /[0-9]+ [0-9]+/.test(i),
                        a = ((i = (i = i.replace(/,/g, "")).replace(/ /g, "")).split(".")[1] || []).length,
                        o = /[0-9]+:[0-9]+:[0-9]+/.test(i);
                    if (o) {
                        var r = i.split(":"),
                            l = 1;
                        for (f = 0; 0 < r.length;) f += l * parseInt(r.pop(), 10), l *= 60
                    }
                    for (var h = e; 1 <= h; h--) {
                        var c, d = parseFloat(i / e * h).toFixed(a);
                        if (o && (d = parseInt(f / e * h), d = ((c = parseInt(d / 3600) % 24) < 10 ? "0" + c : c) + ":" + ((c = parseInt(d / 60) % 60) < 10 ? "0" + c : c) + ":" + ((c = parseInt(d % 60, 10)) < 10 ? "0" + c : c)), s)
                            for (;
                    ...
                    u.data("counterup-nums", t), u.text("0");
                    u.data("counterup-func", function() {
                        u.html(u.data("counterup-nums").shift()), u.data("counterup-nums").length ? setTimeout(u.data("counterup-func"), p.delay) : (u.data("counterup-nums", null), u.data("counterup-func", null), m.callback.call(this))
                    }), setTimeout(u.data("counterup-func"), p.delay)
                }(), this.destroy()
            }, {
                offset: "100%"
            })
...
function(f) {
    ...
    f.zoom = function(t, e, i, s) {
        var n, a, o, r, l, h, c, d = f(t),
            u = d.css("position"),
            p = f(e);
        return t.style.position = /(absolute|fixed)/.test(u) ? u : "relative", t.style.overflow = "hidden", i.style.width = i.style.height = "", f(i).addClass("zoomImg").css({
            position: "absolute",
            top: 0,
            left: 0,
            opacity: 0,
            ...
            init: function() {
                a = d.outerWidth(), n = d.outerHeight(), o = e === t ? (r = a, n) : (r = p.outerWidth(), p.outerHeight()), l = (i.width - a) / r, h = (i.height - n) / o, c = p.offset()
            },
            move: function(t) {
                ...
                i.style.left = e * -l + "px", i.style.top = t * -h + "px"
            }
        }
    }, f.fn.zoom = function(i) {
        return this.each(function() {
            var n = f.extend({}, s, i || {}),
                a = n.target && f(n.target)[0] || this,
                t = this,
                o = f(t),
            ...
            if (!n.url) {
                ...
                if (e && (n.url = e.getAttribute("data-src") || e.currentSrc || e.src), !n.url) return
            }
            o.one("zoom.destroy", function(t, e) {
                o.off(".zoom"), a.style.position = t, a.style.overflow = e, r.onload = null, l.remove()
            }.bind(this, a.style.position, a.style.overflow)), r.onload = function() {
                function e(t) {
                    s.init(), s.move(t), l.stop().fadeTo(f.support.opacity ? n.duration : 0, 1, !!f.isFunction(n.onZoomIn) && n.onZoomIn.call(r))
                }

                function i() {
                    l.stop().fadeTo(n.duration, 0, !!f.isFunction(n.onZoomOut) && n.onZoomOut.call(r))
                }
                var s = f.zoom(a, t, r, n.magnify);
                "grab" === n.on ? o.on("mousedown.zoom", function(t) {
                    1 === t.which && (f(document).one("mouseup.zoom", function() {
                        i(), f(document).off(h, s.move)
                    }), e(t), f(document).on(h, s.move), t.preventDefault())
                }) : "click" === n.on ? o.on("click.zoom", function(t) {
                    return c ? void 0 : (c = !0, e(t), f(document).on(h, s.move), f(document).one("click.zoom", function() {
                        i(), c = !1, f(document).off(h, s.move)
                    }), !1)
                }) : "toggle" === n.on ? o.on("click.zoom", function(t) {
                    c ? i() : e(t), c = !c
                }) : "mouseover" === n.on && (s.init(), o.on("mouseenter.zoom", e).on("mouseleave.zoom", i).on(h, s.move)), n.touch && o.on("touchstart.zoom", function(t) {
                ...
                }), f.isFunction(n.callback) && n.callback.call(r)
            }, r.setAttribute("role", "presentation"), r.alt = "", r.src = n.url
        })
    }, f.fn.zoom.defaults = s
}(window.jQuery),
function(h) {
    "use strict";
    h.ajaxChimp = {
        ...
        return h(this).each(function(t, e) {
            var n = h(e),
                a = n.find("input[type=email]"),
                o = n.find("label[for=" + a.attr("id") + "]"),
                r = h.extend({
                    url: n.attr("action"),
                    language: "en"
                }, i),
            ...
            n.attr("novalidate", "true"), a.attr("name", "EMAIL"), n.submit(function() {
                ...
                h.each(t, function(t, e) {
                    ...
                    data: s,
                    success: function(e) {
                        if ("success" === e.result) i = "We have sent you a confirmation email", o.removeClass("error").addClass("valid"), a.removeClass("error").addClass("valid");
                        else {
...
function(t, e) {
    ...
    var c, d = (c = h(Array), L = c, (O = u).prototype = Object.create(L.prototype), (O.prototype.constructor = O).__proto__ = L, u);

    function u(t) {
        var e = c.call.apply(c, [this].concat(t)) || this,
            t = function(t) {
    ...
    function k(t, n) {
        ...
        } else if (t.nodeType || t === e || t === a) i.push(t);
    ...
    var m, y, _, g = {
        ...
        on: function() {
            ...
            function r(t) {
                ...
                if (e) {
                    ...
                    if (i.indexOf(t) < 0 && i.unshift(t), k(e).is(a)) o.apply(e, i);
                    else
                        for (var s = k(e).parents(), n = 0; n < s.length; n += 1) k(s[n]).is(a) && o.apply(s[n], i)
                }
            }
            ...
            "function" == typeof e[1] && (s = e[0], o = e[1], n = e[2], a = void 0);
            for (var h, n = n || !1, c = s.split(" "), d = 0; d < this.length; d += 1) {
                var u = this[d];
                if (a)
        ...
        off: function() {
            ...
            var s = e[0],
                ...
                a = e[2],
                o = e[3];
            "function" == typeof e[1] && (s = e[0], a = e[1], o = e[2], n = void 0);
            for (var o = o || !1, r = s.split(" "), l = 0; l < r.length; l += 1)
                for (var h = r[l], c = 0; c < this.length; c += 1) {
                    var d = this[c],
                        u = void 0;
                    if (!n && d.dom7Listeners ? u = d.dom7Listeners[h] : n && d.dom7LiveListeners && (u = d.dom7LiveListeners[h]), u && u.length)
                        for (var p = u.length - 1; 0 <= p; --p) {
                            var f = u[p];
                            !(a && f.listener === a || a && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === a) && a || (d.removeEventListener(h, f.proxyListener, o), u.splice(p, 1))
                        }
                }
            return this
        },
        trigger: function() {
            for (var t = K(), e = arguments.length, i = new Array(e), s = 0; s < e; s++) i[s] = arguments[s];
        ...
        offset: function() {
            if (0 < this.length) {
                var t = K(),
                    ...
                    e = i.clientLeft || n.clientLeft || 0,
                    n = i === t ? t.scrollY : i.scrollTop,
                    i = i === t ? t.scrollX : i.scrollLeft;
                return {
                    top: s.top + n - a,
                    left: s.left + i - e
                }
        ...
        append: function() {
            for (var t = b(), e = 0; e < arguments.length; e += 1)
                for (var i = e < 0 || arguments.length <= e ? void 0 : arguments[e], s = 0; s < this.length; s += 1)
                    if ("string" == typeof i) {
        ...
        prepend: function(t) {
            for (var e, i = b(), s = 0; s < this.length; s += 1)
                if ("string" == typeof t) {
                    var n = i.createElement("div");
                    for (n.innerHTML = t, e = n.childNodes.length - 1; 0 <= e; --e) this[s].insertBefore(n.childNodes[e], this[s].childNodes[0])
                } else if (t instanceof d)
                for (e = 0; e < t.length; e += 1) this[s].insertBefore(t[e], this[s].childNodes[0]);
            else this[s].insertBefore(t, this[s].childNodes[0]);
            return this
        },
        next: function(t) {
            return 0 < this.length ? t ? this[0].nextElementSibling && k(this[0].nextElementSibling).is(t) ? k([this[0].nextElementSibling]) : k([]) : this[0].nextElementSibling ? k([this[0].nextElementSibling]) : k([]) : k([])
        },
        nextAll: function(t) {
            var e = [],
                i = this[0];
        ...
        prev: function(t) {
            if (0 < this.length) {
                var e = this[0];
                return t ? e.previousElementSibling && k(e.previousElementSibling).is(t) ? k([e.previousElementSibling]) : k([]) : e.previousElementSibling ? k([e.previousElementSibling]) : k([])
            }
            return k([])
        },
        prevAll: function(t) {
        ...
        parent: function(t) {
            for (var e = [], i = 0; i < this.length; i += 1) null === this[i].parentNode || t && !k(this[i].parentNode).is(t) || e.push(this[i].parentNode);
            return k(e)
        },
        parents: function(t) {
            for (var e = [], i = 0; i < this.length; i += 1)
                for (var s = this[i].parentNode; s;) t && !k(s).is(t) || e.push(s), s = s.parentNode;
            return k(e)
        },
        closest: function(t) {
            var e = this;
            return void 0 === t ? k([]) : e = !e.is(t) ? e.parents(t).eq(0) : e
        },
        find: function(t) {
            for (var e = [], i = 0; i < this.length; i += 1)
        ...
        children: function(t) {
            for (var e = [], i = 0; i < this.length; i += 1)
                for (var s = this[i].children, n = 0; n < s.length; n += 1) t && !k(s[n]).is(t) || e.push(s[n]);
            return k(e)
        },
        filter: function(t) {
            return k(f(this, t))
    ...
    function v(t, e) {
        void 0 === e && (e = "x");
        var i, s, n, a = K(),
            t = a.getComputedStyle(t, null);
        return a.WebKitCSSMatrix ? (6 < (s = t.transform || t.webkitTransform).split(",").length && (s = s.split(", ").map(function(t) {
            return t.replace(",", ".")
        }).join(", ")), n = new a.WebKitCSSMatrix("none" === s ? "" : s)) : i = (n = t.MozTransform || t.OTransform || t.MsTransform || t.msTransform || t.transform || t.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === e && (s = a.WebKitCSSMatrix ? n.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])), (s = "y" === e ? a.WebKitCSSMatrix ? n.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5]) : s) || 0
    }
        ...
        for (var e = Object(arguments.length <= 0 ? void 0 : t), i = 1; i < arguments.length; i += 1) {
            ...
            if (null != s)
                for (var n = Object.keys(Object(s)), a = 0, o = n.length; a < o; a += 1) {
                    ...
                    void 0 !== l && l.enumerable && (w(e[r]) && w(s[r]) ? Q(e[r], s[r]) : !w(e[r]) && w(s[r]) ? (e[r] = {}, Q(e[r], s[r])) : e[r] = s[r])
                }
        }
        return e
    }
    ...
    function x(i, s) {
        Object.keys(s).forEach(function(e) {
            w(s[e]) && Object.keys(s[e]).forEach(function(t) {
    ...
    var S = {
        ...
        M = {
            attach: function(t, e) {
                ...
                var i = K(),
                    s = this,
                    n = new(i.MutationObserver || i.WebkitMutationObserver)(function(t) {
                        var e;
    ...
    var O, L, A, H = {
        ...
        N = {
            ...
            eventsEmitter: {
                ...
                emit: function() {
                    ...
                    return s = "string" == typeof a[0] || Array.isArray(a[0]) ? (t = a[0], i = a.slice(1, a.length), n) : (t = a[0].events, i = a[0].data, a[0].context || n), i.unshift(s), (Array.isArray(t) ? t : t.split(" ")).forEach(function(e) {
                        n.eventsAnyListeners && n.eventsAnyListeners.length && n.eventsAnyListeners.forEach(function(t) {
                            t.apply(s, [e].concat(i))
                        }), n.eventsListeners && n.eventsListeners[e] && n.eventsListeners[e].forEach(function(t) {
                            t.apply(s, i)
                        })
                    }), n
                }
            ...
            update: {
                updateSize: function() {
                    var t = this,
                        e = t.$el,
                        i = void 0 !== t.params.width && null !== t.params.width ? t.params.width : e[0].clientWidth,
                        s = void 0 !== t.params.height && null !== t.params.height ? t.params.height : e[0].clientHeight;
                    0 === i && t.isHorizontal() || 0 === s && t.isVertical() || (i = i - parseInt(e.css("padding-left") || 0, 10) - parseInt(e.css("padding-right") || 0, 10), s = s - parseInt(e.css("padding-top") || 0, 10) - parseInt(e.css("padding-bottom") || 0, 10), Q(t, {
                        width: i = Number.isNaN(i) ? 0 : i,
                        height: s = Number.isNaN(s) ? 0 : s,
                        size: t.isHorizontal() ? i : s
                    }))
                },
                updateSlides: function() {
                    var t = this,
                        ...
                        l = (r ? t.virtual : t).slides.length,
                        h = s.children("." + t.params.slideClass),
                        c = (r ? t.virtual.slides : h).length,
                        d = [],
                        u = [],
                        p = [];
                    ...
                    var v, b = t.snapGrid.length,
                        ...
                        x = 0;
                    if (void 0 !== n) {
                        "string" == typeof y && 0 <= y.indexOf("%") && (y = parseFloat(y.replace("%", "")) / 100 * n), t.virtualSize = -y, a ? h.css({
                            marginLeft: "",
                            marginTop: ""
                        }) : h.css({
                            marginRight: "",
                            marginBottom: ""
                        }), 1 < i.slidesPerColumn && (v = Math.floor(c / i.slidesPerColumn) === c / t.params.slidesPerColumn ? c : Math.ceil(c / i.slidesPerColumn) * i.slidesPerColumn, "auto" !== i.slidesPerView && "row" === i.slidesPerColumnFill && (v = Math.max(v, i.slidesPerView * i.slidesPerColumn)));
                        for (var C, k, T, E, S = i.slidesPerColumn, M = v / S, I = Math.floor(c / i.slidesPerColumn), D = 0; D < c; D += 1) {
                            H = 0;
                            var P, z, O, L, A, H, N, W, F, R, B, Y, $, j = h.eq(D);
                            1 < i.slidesPerColumn && (A = L = O = void 0, "row" === i.slidesPerColumnFill && 1 < i.slidesPerGroup ? (z = Math.floor(D / (i.slidesPerGroup * i.slidesPerColumn)), P = D - i.slidesPerColumn * i.slidesPerGroup * z, Y = 0 === z ? i.slidesPerGroup : Math.min(Math.ceil((c - z * S * i.slidesPerGroup) / S), i.slidesPerGroup), O = (L = P - (A = Math.floor(P / Y)) * Y + z * i.slidesPerGroup) + A * v / S, j.css({
                                "-webkit-box-ordinal-group": O,
                                "-moz-box-ordinal-group": O,
                                "-ms-flex-order": O,
                                "-webkit-order": O,
                                order: O
                            })) : "column" === i.slidesPerColumnFill ? (A = D - (L = Math.floor(D / S)) * S, (I < L || L === I && A === S - 1) && (A += 1) >= S && (A = 0, L += 1)) : L = D - (A = Math.floor(D / M)) * M, j.css("margin-" + (t.isHorizontal() ? "top" : "left"), 0 !== A && i.spaceBetween && i.spaceBetween + "px")), "none" !== j.css("display") && ("auto" === i.slidesPerView ? (Y = e.getComputedStyle(j[0], null), z = j[0].style.transform, O = j[0].style.webkitTransform, z && (j[0].style.transform = "none"), O && (j[0].style.webkitTransform = "none"), H = i.roundLengths ? t.isHorizontal() ? j.outerWidth(!0) : j.outerHeight(!0) : t.isHorizontal() ? (L = parseFloat(Y.getPropertyValue("width") || 0), N = parseFloat(Y.getPropertyValue("padding-left") || 0), W = parseFloat(Y.getPropertyValue("padding-right") || 0), F = parseFloat(Y.getPropertyValue("margin-left") || 0), R = parseFloat(Y.getPropertyValue("margin-right") || 0), (A = Y.getPropertyValue("box-sizing")) && "border-box" === A ? L + F + R : ($ = (B = j[0]).clientWidth, L + N + W + F + R + (B.offsetWidth - $))) : (N = parseFloat(Y.getPropertyValue("height") || 0), W = parseFloat(Y.getPropertyValue("padding-top") || 0), F = parseFloat(Y.getPropertyValue("padding-bottom") || 0), R = parseFloat(Y.getPropertyValue("margin-top") || 0), B = parseFloat(Y.getPropertyValue("margin-bottom") || 0), ($ = Y.getPropertyValue("box-sizing")) && "border-box" === $ ? N + R + B : ($ = (Y = j[0]).clientHeight, N + W + F + R + B + (Y.offsetHeight - $))), z && (j[0].style.transform = z), O && (j[0].style.webkitTransform = O), i.roundLengths && (H = Math.floor(H))) : (H = (n - (i.slidesPerView - 1) * y) / i.slidesPerView, i.roundLengths && (H = Math.floor(H)), h[D] && (t.isHorizontal() ? h[D].style.width = H + "px" : h[D].style.height = H + "px")), h[D] && (h[D].swiperSlideSize = H), p.push(H), i.centeredSlides ? (_ = _ + H / 2 + w / 2 + y, 0 === w && 0 !== D && (_ = _ - n / 2 - y), 0 === D && (_ = _ - n / 2 - y), Math.abs(_) < .001 && (_ = 0), i.roundLengths && (_ = Math.floor(_)), x % i.slidesPerGroup == 0 && d.push(_), u.push(_)) : (i.roundLengths && (_ = Math.floor(_)), (x - Math.min(t.params.slidesPerGroupSkip, x)) % t.params.slidesPerGroup == 0 && d.push(_), u.push(_), _ = _ + H + y), t.virtualSize += H + y, w = H, x += 1)
                        }
                        if (t.virtualSize = Math.max(t.virtualSize, n) + g, a && o && ("slide" === i.effect || "coverflow" === i.effect) && s.css({
                                width: t.virtualSize + i.spaceBetween + "px"
                            }), i.setWrapperSize && (t.isHorizontal() ? s.css({
                                width: t.virtualSize + i.spaceBetween + "px"
                            }) : s.css({
                                height: t.virtualSize + i.spaceBetween + "px"
                            })), 1 < i.slidesPerColumn && (t.virtualSize = (H + i.spaceBetween) * v, t.virtualSize = Math.ceil(t.virtualSize / i.slidesPerColumn) - i.spaceBetween, t.isHorizontal() ? s.css({
                                width: t.virtualSize + i.spaceBetween + "px"
                            }) : s.css({
                                height: t.virtualSize + i.spaceBetween + "px"
                            }), i.centeredSlides)) {
                            for (var q = [], X = 0; X < d.length; X += 1) {
                                var V = d[X];
                                i.roundLengths && (V = Math.floor(V)), d[X] < t.virtualSize + d[0] && q.push(V)
                            }
                            d = q
                        }
                        if (!i.centeredSlides) {
                            ...
                            for (var G = 0; G < d.length; G += 1) {
                                var U = d[G];
                                i.roundLengths && (U = Math.floor(U)), d[G] <= t.virtualSize - n && q.push(U)
                            }
                            d = q, 1 < Math.floor(t.virtualSize - n) - Math.floor(d[d.length - 1]) && d.push(t.virtualSize - n)
                        }
                        0 === d.length && (d = [0]), 0 !== i.spaceBetween && (t.isHorizontal() ? a ? h.filter(f).css({
                            marginLeft: y + "px"
                        }) : h.filter(f).css({
                            marginRight: y + "px"
                        }) : h.filter(f).css({
                            marginBottom: y + "px"
                        })), i.centeredSlides && i.centeredSlidesBounds && (C = 0, p.forEach(function(t) {
                            C += t + (i.spaceBetween || 0)
                        }), k = (C -= i.spaceBetween) - n, d = d.map(function(t) {
                            return t < 0 ? -m : k < t ? k + g : t
                        })), i.centerInsufficientSlides && (T = 0, p.forEach(function(t) {
                            T += t + (i.spaceBetween || 0)
                        }), (T -= i.spaceBetween) < n && (E = (n - T) / 2, d.forEach(function(t, e) {
                            d[e] = t - E
                            ...
                            slidesGrid: u,
                            slidesSizesGrid: p
                        }), c !== l && t.emit("slidesLengthChange"), d.length !== b && (t.params.watchOverflow && t.checkOverflow(), t.emit("snapGridLengthChange")), u.length !== r && t.emit("slidesGridLengthChange"), (i.watchSlidesProgress || i.watchSlidesVisibility) && t.updateSlidesOffset()
                    }
                },
                updateAutoHeight: function(t) {
                    var e, i, s = this,
                        n = [],
                        a = 0;
                    if ("number" == typeof t ? s.setTransition(t) : !0 === t && s.setTransition(s.params.speed), "auto" !== s.params.slidesPerView && 1 < s.params.slidesPerView)
                        if (s.params.centeredSlides) s.visibleSlides.each(function(t) {
                            n.push(t)
                        });
                        else
                            for (e = 0; e < Math.ceil(s.params.slidesPerView); e += 1) {
                                var o = s.activeIndex + e;
                                if (o > s.slides.length) break;
                                n.push(s.slides.eq(o)[0])
                            } else n.push(s.slides.eq(s.activeIndex)[0]);
                    for (e = 0; e < n.length; e += 1) void 0 !== n[e] && (a = a < (i = n[e].offsetHeight) ? i : a);
                    a && s.$wrapperEl.css("height", a + "px")
                },
                ...
                updateSlidesProgress: function(t) {
                    ...
                    if (0 !== s.length) {
                        ...
                        var a = n ? t : -t;
                        s.removeClass(i.slideVisibleClass), e.visibleSlidesIndexes = [], e.visibleSlides = [];
                        for (var o = 0; o < s.length; o += 1) {
                            var r, l, h = s[o],
                                c = (a + (i.centeredSlides ? e.minTranslate() : 0) - h.swiperSlideOffset) / (h.swiperSlideSize + i.spaceBetween);
                            (i.watchSlidesVisibility || i.centeredSlides && i.autoHeight) && (l = (r = -(a - h.swiperSlideOffset)) + e.slidesSizesGrid[o], (0 <= r && r < e.size - 1 || 1 < l && l <= e.size || r <= 0 && l >= e.size) && (e.visibleSlides.push(h), e.visibleSlidesIndexes.push(o), s.eq(o).addClass(i.slideVisibleClass))), h.progress = n ? -c : c
                        }
                ...
                updateProgress: function(t) {
                    var e = this;
                    void 0 === t && (r = e.rtlTranslate ? -1 : 1, t = e && e.translate && e.translate * r || 0);
                    var i = e.params,
                        ...
                        o = a,
                        r = l = e.isEnd,
                        l = 0 == s ? a = !(n = 0) : (a = (n = (t - e.minTranslate()) / s) <= 0, 1 <= n);
                    Q(e, {
                        progress: n,
                        isBeginning: a,
                        isEnd: l
                    }), (i.watchSlidesProgress || i.watchSlidesVisibility || i.centeredSlides && i.autoHeight) && e.updateSlidesProgress(t), a && !o && e.emit("reachBeginning toEdge"), l && !r && e.emit("reachEnd toEdge"), (o && !a || r && !l) && e.emit("fromEdge"), e.emit("progress", n)
                },
                ...
                updateActiveIndex: function(t) {
                    ...
                    }(a = 0 <= n.indexOf(i) ? n.indexOf(i) : (t = Math.min(a.slidesPerGroupSkip, h)) + Math.floor((h - t) / a.slidesPerGroup)) >= n.length && (a = n.length - 1), h !== o ? (n = parseInt(e.slides.eq(h).attr("data-swiper-slide-index") || h, 10), Q(e, {
                        snapIndex: a,
                        realIndex: n,
                        previousIndex: o,
                        activeIndex: h
                    }), e.emit("activeIndexChange"), e.emit("snapIndexChange"), r !== n && e.emit("realIndexChange"), (e.initialized || e.params.runCallbacksOnInit) && e.emit("slideChange")) : a !== l && (e.snapIndex = a, e.emit("snapIndexChange"))
                },
                updateClickedSlide: function(t) {
                    var e = this,
                        i = e.params,
                        s = k(t.target).closest("." + i.slideClass)[0],
                        n = !1;
                    if (s)
                        for (var a = 0; a < e.slides.length; a += 1) e.slides[a] === s && (n = !0);
                    if (!s || !n) return e.clickedSlide = void 0, void(e.clickedIndex = void 0);
                    e.clickedSlide = s, e.virtual && e.params.virtual.enabled ? e.clickedIndex = parseInt(k(s).attr("data-swiper-slide-index"), 10) : e.clickedIndex = k(s).index(), i.slideToClickedSlide && void 0 !== e.clickedIndex && e.clickedIndex !== e.activeIndex && e.slideToClickedSlide()
                }
            },
            translate: {
                ...
                setTranslate: function(t, e) {
                    var i = this,
                        ...
                        l = 0,
                        h = 0;
                    i.isHorizontal() ? l = s ? -t : t : h = t, n.roundLengths && (l = Math.floor(l), h = Math.floor(h)), n.cssMode ? o[i.isHorizontal() ? "scrollLeft" : "scrollTop"] = i.isHorizontal() ? -l : -h : n.virtualTranslate || a.transform("translate3d(" + l + "px, " + h + "px, 0px)"), i.previousTranslate = i.translate, i.translate = i.isHorizontal() ? l : h;
                    h = i.maxTranslate() - i.minTranslate();
            ...
            transition: {
                ...
                transitionEnd: function(t, e) {
                    ...
                    var i = this,
                        ...
                        n = i.previousIndex,
                        a = i.params;
                    i.animating = !1, a.cssMode || (i.setTransition(0), e = (e = e) || (n < s ? "next" : s < n ? "prev" : "reset"), i.emit("transitionEnd"), t && s !== n && ("reset" !== e ? (i.emit("slideChangeTransitionEnd"), "next" === e ? i.emit("slideNextTransitionEnd") : i.emit("slidePrevTransitionEnd")) : i.emit("slideResetTransitionEnd")))
                }
            },
            slide: {
                slideTo: function(t, e, i, s) {
                    if (void 0 === e && (e = this.params.speed), void 0 === i && (i = !0), "number" != typeof(t = void 0 === t ? 0 : t) && "string" != typeof t) throw new Error("The 'index' argument cannot have type other than 'number' or 'string'. [" + typeof t + "] given.");
                    if ("string" == typeof t) {
                        var n = parseInt(t, 10);
                    ...
                    t = Math.min(a.params.slidesPerGroupSkip, o), t += Math.floor((o - t) / a.params.slidesPerGroup);
                    t >= l.length && (t = l.length - 1), (d || r.initialSlide || 0) === (c || 0) && i && a.emit("beforeSlideChangeStart");
                    var p, f = -l[t];
                    if (a.updateProgress(f), r.normalizeSlideIndex)
                        for (var m = 0; m < h.length; m += 1) {
                            var g = -Math.floor(100 * f),
                                v = Math.floor(100 * h[m]),
                                b = Math.floor(100 * h[m + 1]);
                            void 0 !== h[m + 1] ? v <= g && g < b - (b - v) / 2 ? o = m : v <= g && g < b && (o = m + 1) : v <= g && (o = m)
                        }
                    if (a.initialized && o !== d) {
                        if (!a.allowSlideNext && f < a.translate && f < a.minTranslate()) return !1;
                        if (!a.allowSlidePrev && f > a.translate && f > a.maxTranslate() && (d || 0) !== o) return !1
                    }
                    if (p = d < o ? "next" : o < d ? "prev" : "reset", u && -f === a.translate || !u && f === a.translate) return a.updateActiveIndex(o), r.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== r.effect && a.setTranslate(f), "reset" != p && (a.transitionStart(i, p), a.transitionEnd(i, p)), !1;
                    if (r.cssMode) {
                        d = a.isHorizontal(), r = -f;
                        return u && (r = n.scrollWidth - n.offsetWidth - r), 0 !== e && n.scrollTo ? n.scrollTo(((u = {})[d ? "left" : "top"] = r, u.behavior = "smooth", u)) : n[d ? "scrollLeft" : "scrollTop"] = r, !0
                    }
                    return 0 === e ? (a.setTransition(0), a.setTranslate(f), a.updateActiveIndex(o), a.updateSlidesClasses(), a.emit("beforeTransitionStart", e, s), a.transitionStart(i, p), a.transitionEnd(i, p)) : (a.setTransition(e), a.setTranslate(f), a.updateActiveIndex(o), a.updateSlidesClasses(), a.emit("beforeTransitionStart", e, s), a.transitionStart(i, p), a.animating || (a.animating = !0, a.onSlideToWrapperTransitionEnd || (a.onSlideToWrapperTransitionEnd = function(t) {
                        a && !a.destroyed && t.target === this && (a.$wrapperEl[0].removeEventListener("transitionend", a.onSlideToWrapperTransitionEnd), a.$wrapperEl[0].removeEventListener("webkitTransitionEnd", a.onSlideToWrapperTransitionEnd), a.onSlideToWrapperTransitionEnd = null, delete a.onSlideToWrapperTransitionEnd, a.transitionEnd(i, p))
                    }), a.$wrapperEl[0].addEventListener("transitionend", a.onSlideToWrapperTransitionEnd), a.$wrapperEl[0].addEventListener("webkitTransitionEnd", a.onSlideToWrapperTransitionEnd))), !0
                },
                slideToLoop: function(t, e, i, s) {
                    void 0 === e && (e = this.params.speed);
                    t = void 0 === t ? 0 : t;
                    return this.params.loop && (t += this.loopedSlides), this.slideTo(t, e, i = void 0 === i ? !0 : i, s)
                },
                ...
                slidePrev: function(t, e, i) {
                    ...
                    var c = h(l ? s.translate : -s.translate),
                        l = o.map(h);
                    o[l.indexOf(c)];
                    var d, u = o[l.indexOf(c) - 1];
                    return void 0 === u && n.cssMode && o.forEach(function(t) {
                        !u && t <= c && (u = t)
                    }), void 0 !== u && (d = r.indexOf(u)) < 0 && (d = s.activeIndex - 1), s.slideTo(d, t, e, i)
                },
                ...
                slideToClosest: function(t, e, i, s) {
                    ...
                    return l >= n.snapGrid[r] ? l - (o = n.snapGrid[r]) > (n.snapGrid[r + 1] - o) * s && (a += n.params.slidesPerGroup) : l - (l = n.snapGrid[r - 1]) <= (n.snapGrid[r] - l) * s && (a -= n.params.slidesPerGroup), a = Math.max(a, 0), a = Math.min(a, n.slidesGrid.length - 1), n.slideTo(a, t, e, i)
                },
                slideToClickedSlide: function() {
                    var t, e = this,
                        ...
                        a = e.clickedIndex;
                    i.loop ? e.animating || (t = parseInt(k(e.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? a < e.loopedSlides - n / 2 || a > e.slides.length - e.loopedSlides + n / 2 ? (e.loopFix(), a = s.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), T(function() {
                        e.slideTo(a)
                ...
                loopCreate: function() {
                    ...
                    if (e.loopFillGroupWithBlank) {
                        ...
                        if (a !== e.slidesPerGroup) {
                            for (var o = 0; o < a; o += 1) {
                                var r = k(t.createElement("div")).addClass(e.slideClass + " " + e.slideBlankClass);
                                i.append(r)
                            }
                    ...
                    for (var c = 0; c < h.length; c += 1) i.append(k(h[c].cloneNode(!0)).addClass(e.slideDuplicateClass));
                    for (var d = l.length - 1; 0 <= d; --d) i.prepend(k(l[d].cloneNode(!0)).addClass(e.slideDuplicateClass))
                },
                loopFix: function() {
                    var t = this;
                    ...
                    r = -r[i] - t.getTranslate();
                    i < n ? (e = s.length - 3 * n + i, t.slideTo(e += n, 0, !1, !0) && 0 != r && t.setTranslate((l ? -t.translate : t.translate) - r)) : i >= s.length - n && (e = -s.length + i + n, t.slideTo(e += n, 0, !1, !0) && 0 != r && t.setTranslate((l ? -t.translate : t.translate) - r)), t.allowSlidePrev = a, t.allowSlideNext = o, t.emit("loopFix")
                },
            ...
            manipulation: {
                ...
                addSlide: function(t, e) {
                    ...
                    if (t <= 0) i.prependSlide(e);
                        ...
                        for (var r = t < a ? a + 1 : a, l = [], h = o - 1; t <= h; --h) {
                            var c = i.slides.eq(h);
                        ...
                        n.loop && i.loopCreate(), n.observer && i.support.observer || i.update(), n.loop ? i.slideTo(r + i.loopedSlides, 0, !1) : i.slideTo(r, 0, !1)
                    }
                },
                removeSlide: function(t) {
                    var e = this,
                        ...
                        s = e.$wrapperEl,
                        n = e.activeIndex;
                    i.loop && (n -= e.loopedSlides, e.loopDestroy(), e.slides = s.children("." + i.slideClass));
                    var a, o = n;
                    if ("object" == typeof t && "length" in t) {
                    ...
                    i.loop && e.loopCreate(), i.observer && e.support.observer || e.update(), i.loop ? e.slideTo(o + e.loopedSlides, 0, !1) : e.slideTo(o, 0, !1)
                },
                ...
                attachEvents: function() {
                    ...
                    t.onTouchStart = function(t) {
                        ...
                        if (!e.animating || !a.preventInteractionOnTransition) {
                            var r = t,
                                l = k((r = r.originalEvent ? r.originalEvent : r).target);
                            if (("wrapper" !== a.touchEventsTarget || l.closest(e.wrapperEl).length) && (n.isTouchEvent = "touchstart" === r.type, (n.isTouchEvent || !("which" in r) || 3 !== r.which) && !(!n.isTouchEvent && "button" in r && 0 < r.button || n.isTouched && n.isMoved)))
                                if (a.noSwipingClass && "" !== a.noSwipingClass && r.target && r.target.shadowRoot && t.path && t.path[0] && (l = k(t.path[0])), a.noSwiping && l.closest(a.noSwipingSelector || "." + a.noSwipingClass)[0]) e.allowClick = !0;
                                else if (!a.swipeHandler || l.closest(a.swipeHandler)[0]) {
                                o.currentX = ("touchstart" === r.type ? r.targetTouches[0] : r).pageX, o.currentY = ("touchstart" === r.type ? r.targetTouches[0] : r).pageY;
                                var h = o.currentX,
                                    c = o.currentY,
                                    d = a.edgeSwipeDetection || a.iOSEdgeSwipeDetection,
                                    u = a.edgeSwipeThreshold || a.iOSEdgeSwipeThreshold;
                                if (d && (h <= u || h >= s.innerWidth - u)) {
                                    if ("prevent" !== d) return;
                                    t.preventDefault()
                                }
                                Q(n, {
                                    ...
                                    isScrolling: void 0,
                                    startMoving: void 0
                                }), o.startX = h, o.startY = c, n.touchStartTime = E(), e.allowClick = !0, e.updateSize(), e.swipeDirection = void 0, 0 < a.threshold && (n.allowThresholdMove = !1), "touchstart" !== r.type && (c = !0, l.is(n.formElements) && (c = !1), i.activeElement && k(i.activeElement).is(n.formElements) && i.activeElement !== l[0] && i.activeElement.blur(), c = c && e.allowTouchMove && a.touchStartPreventDefault, !a.touchStartForcePreventDefault && !c || l[0].isContentEditable || r.preventDefault()), e.emit("touchStart", r)
                            }
                        }
                        ...
                        if (r.originalEvent && (r = r.originalEvent), s.isTouched) {
                            if (!s.isTouchEvent || "touchmove" === r.type) {
                                var l = "touchmove" === r.type && r.targetTouches && (r.targetTouches[0] || r.changedTouches[0]),
                                    t = ("touchmove" === r.type ? l : r).pageX,
                                    l = ("touchmove" === r.type ? l : r).pageY;
                                if (r.preventedByNestedSwiper) return a.startX = t, void(a.startY = l);
                                if (!i.allowTouchMove) return i.allowClick = !1, void(s.isTouched && (Q(a, {
                                    startX: t,
                                    startY: l,
                                    currentX: t,
                                    currentY: l
                                ...
                                if (s.isTouchEvent && n.touchReleaseOnEdges && !n.loop)
                                    if (i.isVertical()) {
                                        if (l < a.startY && i.translate <= i.maxTranslate() || l > a.startY && i.translate >= i.minTranslate()) return s.isTouched = !1, void(s.isMoved = !1)
                                    } else if (t < a.startX && i.translate <= i.maxTranslate() || t > a.startX && i.translate >= i.minTranslate()) return;
                                if (s.isTouchEvent && e.activeElement && r.target === e.activeElement && k(r.target).is(s.formElements)) return s.isMoved = !0, void(i.allowClick = !1);
                                if (s.allowTouchCallbacks && i.emit("touchMove", r), !(r.targetTouches && 1 < r.targetTouches.length)) {
                                    a.currentX = t, a.currentY = l;
                                    e = a.currentX - a.startX, t = a.currentY - a.startY;
                                    if (!(i.params.threshold && Math.sqrt(Math.pow(e, 2) + Math.pow(t, 2)) < i.params.threshold))
                                        if (void 0 === s.isScrolling && (i.isHorizontal() && a.currentY === a.startY || i.isVertical() && a.currentX === a.startX ? s.isScrolling = !1 : 25 <= e * e + t * t && (l = 180 * Math.atan2(Math.abs(t), Math.abs(e)) / Math.PI, s.isScrolling = i.isHorizontal() ? l > n.touchAngle : 90 - l > n.touchAngle)), s.isScrolling && i.emit("touchMoveOpposite", r), void 0 === s.startMoving && (a.currentX === a.startX && a.currentY === a.startY || (s.startMoving = !0)), s.isScrolling) s.isTouched = !1;
                                        else if (s.startMoving) {
                                        i.allowClick = !1, !n.cssMode && r.cancelable && r.preventDefault(), n.touchMoveStopPropagation && !n.nested && r.stopPropagation(), s.isMoved || (n.loop && i.loopFix(), s.startTranslate = i.getTranslate(), i.setTransition(0), i.animating && i.$wrapperEl.trigger("webkitTransitionEnd transitionend"), s.allowMomentumBounce = !1, !n.grabCursor || !0 !== i.allowSlideNext && !0 !== i.allowSlidePrev || i.setGrabCursor(!0), i.emit("sliderFirstMove", r)), i.emit("sliderMove", r), s.isMoved = !0;
                                        e = i.isHorizontal() ? e : t;
                                        a.diff = e, e *= n.touchRatio, i.swipeDirection = 0 < (e = o ? -e : e) ? "prev" : "next", s.currentTranslate = e + s.startTranslate;
                                        t = !0, o = n.resistanceRatio;
                                        if (n.touchReleaseOnEdges && (o = 0), 0 < e && s.currentTranslate > i.minTranslate() ? (t = !1, n.resistance && (s.currentTranslate = i.minTranslate() - 1 + Math.pow(-i.minTranslate() + s.startTranslate + e, o))) : e < 0 && s.currentTranslate < i.maxTranslate() && (t = !1, n.resistance && (s.currentTranslate = i.maxTranslate() + 1 - Math.pow(i.maxTranslate() - s.startTranslate - e, o))), t && (r.preventedByNestedSwiper = !0), !i.allowSlideNext && "next" === i.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !i.allowSlidePrev && "prev" === i.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), 0 < n.threshold) {
                                            if (!(Math.abs(e) > n.threshold || s.allowThresholdMove)) return void(s.currentTranslate = s.startTranslate);
                        ...
                        } else s.startMoving && s.isScrolling && i.emit("touchMoveOpposite", r)
                        ...
                        if (e.allowClick && (e.updateClickedSlide(h), e.emit("tap click", h), t < 300 && d - i.lastClickTime < 300 && e.emit("doubleTap doubleClick", h)), i.lastClickTime = E(), T(function() {
                        ...
                        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, c = s.followFinger ? a ? e.translate : -e.translate : -i.currentTranslate, !s.cssMode)
                            if (s.freeMode)
                                if (c < -e.minTranslate()) e.slideTo(e.activeIndex);
                                else if (c > -e.maxTranslate()) e.slides.length < l.length ? e.slideTo(l.length - 1) : e.slideTo(e.slides.length - 1);
                        else {
                            if (s.freeModeMomentum) {
                                1 < i.velocities.length ? (v = i.velocities.pop(), p = i.velocities.pop(), u = v.position - p.position, p = v.time - p.time, e.velocity = u / p, e.velocity /= 2, Math.abs(e.velocity) < s.freeModeMinimumVelocity && (e.velocity = 0), (150 < p || 300 < E() - v.time) && (e.velocity = 0)) : e.velocity = 0, e.velocity *= s.freeModeMomentumVelocityRatio, i.velocities.length = 0;
                                var u = 1e3 * s.freeModeMomentumRatio,
                                    p = e.velocity * u,
                                    f = e.translate + p;
                                a && (f = -f);
                                var m, g, v = !1,
                                    p = 20 * Math.abs(e.velocity) * s.freeModeMomentumBounceRatio;
                                if (f < e.maxTranslate()) s.freeModeMomentumBounce ? (f + e.maxTranslate() < -p && (f = e.maxTranslate() - p), m = e.maxTranslate(), i.allowMomentumBounce = v = !0) : f = e.maxTranslate(), s.loop && s.centeredSlides && (g = !0);
                                else if (f > e.minTranslate()) s.freeModeMomentumBounce ? (f - e.minTranslate() > p && (f = e.minTranslate() + p), m = e.minTranslate(), i.allowMomentumBounce = v = !0) : f = e.minTranslate(), s.loop && s.centeredSlides && (g = !0);
                                ...
                                if (g && e.once("transitionEnd", function() {
                                        e.loopFix()
                                    }), 0 !== e.velocity) u = a ? Math.abs((-f - e.translate) / e.velocity) : Math.abs((f - e.translate) / e.velocity), s.freeModeSticky && (u = (g = Math.abs((a ? -f : f) - e.translate)) < (a = e.slidesSizesGrid[e.activeIndex]) ? s.speed : g < 2 * a ? 1.5 * s.speed : 2.5 * s.speed);
                                else if (s.freeModeSticky) return void e.slideToClosest();
                                s.freeModeMomentumBounce && v ? (e.updateProgress(m), e.setTransition(u), e.setTranslate(f), e.transitionStart(!0, e.swipeDirection), e.animating = !0, o.transitionEnd(function() {
                                ...
                                })) : e.velocity ? (e.updateProgress(f), e.setTransition(u), e.setTranslate(f), e.transitionStart(!0, e.swipeDirection), e.animating || (e.animating = !0, o.transitionEnd(function() {
                                    e && !e.destroyed && e.transitionEnd()
                            ...
                            for (var _ = 0, w = e.slidesSizesGrid[0], x = 0; x < r.length; x += x < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup) {
                                ...
                                void 0 !== r[x + C] ? c >= r[x] && c < r[x + C] && (w = r[(_ = x) + C] - r[x]) : c >= r[x] && (_ = x, w = r[r.length - 1] - r[r.length - 2])
                            }
                            v = (c - r[_]) / w, u = _ < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
                            t > s.longSwipesMs ? s.longSwipes ? ("next" === e.swipeDirection && (v >= s.longSwipesRatio ? e.slideTo(_ + u) : e.slideTo(_)), "prev" === e.swipeDirection && (v > 1 - s.longSwipesRatio ? e.slideTo(_ + u) : e.slideTo(_))) : e.slideTo(e.activeIndex) : s.shortSwipes ? !e.navigation || h.target !== e.navigation.nextEl && h.target !== e.navigation.prevEl ? ("next" === e.swipeDirection && e.slideTo(_ + u), "prev" === e.swipeDirection && e.slideTo(_)) : h.target === e.navigation.nextEl ? e.slideTo(_ + u) : e.slideTo(_) : e.slideTo(e.activeIndex)
                        }
                    ...
                    var l, h = !!i.nested;
                    !r.touch && r.pointerEvents ? (n.addEventListener(s.start, t.onTouchStart, !1), e.addEventListener(s.move, t.onTouchMove, h), e.addEventListener(s.end, t.onTouchEnd, !1)) : (r.touch && (l = !("touchstart" !== s.start || !r.passiveListener || !i.passiveListeners) && {
                        passive: !0,
                        capture: !1
                    }, n.addEventListener(s.start, t.onTouchStart, l), n.addEventListener(s.move, t.onTouchMove, r.passiveListener ? {
                        passive: !1,
                        capture: h
                    } : h), n.addEventListener(s.end, t.onTouchEnd, l), s.cancel && n.addEventListener(s.cancel, t.onTouchEnd, l), P || (e.addEventListener("touchstart", z), P = !0)), (i.simulateTouch && !o.ios && !o.android || i.simulateTouch && !r.touch && o.ios) && (n.addEventListener("mousedown", t.onTouchStart, !1), e.addEventListener("mousemove", t.onTouchMove, h), e.addEventListener("mouseup", t.onTouchEnd, !1))), (i.preventClicks || i.preventClicksPropagation) && n.addEventListener("click", t.onClick, !0), i.cssMode && a.addEventListener("scroll", t.onScroll), i.updateOnWindowResize ? t.on(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", D, !0) : t.on("observerUpdate", D, !0)
                },
            ...
            breakpoints: {
                setBreakpoint: function() {
                    var t, i, e, s = this,
                        ...
                        h = s.$el,
                        c = l.breakpoints;
                    !c || c && 0 === Object.keys(c).length || (t = s.getBreakpoint(c)) && s.currentBreakpoint !== t && ((i = t in c ? c[t] : void 0) && ["slidesPerView", "spaceBetween", "slidesPerGroup", "slidesPerGroupSkip", "slidesPerColumn"].forEach(function(t) {
                        var e = i[t];
                        void 0 !== e && (i[t] = "slidesPerView" !== t || "AUTO" !== e && "auto" !== e ? "slidesPerView" === t ? parseFloat(e) : parseInt(e, 10) : "auto")
                    }), e = i || s.originalParams, o = 1 < l.slidesPerColumn, c = 1 < e.slidesPerColumn, o && !c ? (h.removeClass(l.containerModifierClass + "multirow " + l.containerModifierClass + "multirow-column"), s.emitContainerClasses()) : !o && c && (h.addClass(l.containerModifierClass + "multirow"), "column" === e.slidesPerColumnFill && h.addClass(l.containerModifierClass + "multirow-column"), s.emitContainerClasses()), h = e.direction && e.direction !== l.direction, l = l.loop && (e.slidesPerView !== l.slidesPerView || h), h && a && s.changeDirection(), Q(s.params, e), Q(s, {
                        allowTouchMove: s.params.allowTouchMove,
                        allowSlideNext: s.params.allowSlideNext,
                        allowSlidePrev: s.params.allowSlidePrev
                    }), s.currentBreakpoint = t, s.emit("_beforeBreakpoint", e), l && a && (s.loopDestroy(), s.loopCreate(), s.updateSlides(), s.slideTo(n - r + s.loopedSlides, 0, !1)), s.emit("breakpoint", e))
                },
            ...
            checkOverflow: {
                checkOverflow: function() {
                    var t = this,
                        e = t.params,
                        i = t.isLocked,
                        s = 0 < t.slides.length && e.slidesOffsetBefore + e.spaceBetween * (t.slides.length - 1) + t.slides[0].offsetWidth * t.slides.length;
                    e.slidesOffsetBefore && e.slidesOffsetAfter && s ? t.isLocked = s <= t.size : t.isLocked = 1 === t.snapGrid.length, t.allowSlideNext = !t.isLocked, t.allowSlidePrev = !t.isLocked, i !== t.isLocked && t.emit(t.isLocked ? "lock" : "unlock"), i && i !== t.isLocked && (t.isEnd = !1, t.navigation && t.navigation.update())
                }
            },
            classes: {
                addClasses: function() {
                    var e = this.classNames,
                        ...
                        a = this.support,
                        o = [];
                    o.push("initialized"), o.push(i.direction), a.pointerEvents && !a.touch && o.push("pointer-events"), i.freeMode && o.push("free-mode"), i.autoHeight && o.push("autoheight"), t && o.push("rtl"), 1 < i.slidesPerColumn && (o.push("multirow"), "column" === i.slidesPerColumnFill && o.push("multirow-column")), n.android && o.push("android"), n.ios && o.push("ios"), i.cssMode && o.push("css-mode"), o.forEach(function(t) {
            ...
            images: {
                loadImage: function(t, e, i, s, n, a) {
                    ...
                    function r() {
                        a && a()
                    }!(k(t).parent("picture")[0] || t.complete && n) && e ? ((o = new o.Image).onload = r, o.onerror = r, s && (o.sizes = s), i && (o.srcset = i), e && (o.src = e)) : r()
                },
        ...
        F = ((A = R.prototype).emitContainerClasses = function() {
            ...
            var i, s = this;
            s.params._emitClasses && s.el && (i = [], s.slides.each(function(t) {
                var e = s.getSlideClasses(t);
                i.push({
                    slideEl: t,
                    classNames: e
                }), s.emit("_slideClass", t, e)
            ...
            if (t.centeredSlides) {
                ...
                for (var c = n + 1; c < e.length; c += 1) i[c] - i[n] < s && (a += 1);
            return a
        }, A.update = function() {
            var t, e, i = this;
            ...
            return (e = e || ("horizontal" === s ? "vertical" : "horizontal")) === s || "horizontal" !== e && "vertical" !== e || (i.$el.removeClass("" + i.params.containerModifierClass + s).addClass("" + i.params.containerModifierClass + e), i.emitContainerClasses(), i.params.direction = e, i.slides.each(function(t) {
                "vertical" === e ? t.style.width = "" : t.style.height = ""
            }), i.emit("changeDirection"), t && i.update()), i
        }, A.mount = function(t) {
            if (this.mounted) return !0;
            var e, i = k(t || this.params.el);
            return !!(t = i[0]) && (t.swiper = this, t && t.shadowRoot && t.shadowRoot.querySelector ? (e = k(t.shadowRoot.querySelector("." + this.params.wrapperClass))).children = function(t) {
                return i.children(t)
            } : e = i.children("." + this.params.wrapperClass), Q(this, {
                $el: i,
                el: t,
                $wrapperEl: e,
                wrapperEl: e[0],
            ...
            var e = t.name || Object.keys(R.prototype.modules).length + "_" + E();
    ...
    function R() {
        ...
        if (i = Q({}, i = (i = 1 === e.length && e[0].constructor && e[0].constructor === Object ? e[0] : (v = e[0], e[1])) || {}), v && !i.el && (i.el = v), i.el && 1 < k(i.el).length) {
            var n = [];
        ...
        var a, o, r, l, h, c, d, u, p, f, m, g = this;
        g.support = C(), g.device = (void 0 === (a = {
            userAgent: i.userAgent
        }) && (a = {}), y || (o = (void 0 === a ? {} : a).userAgent, r = C(), l = K(), h = l.navigator.platform, c = o || l.navigator.userAgent, d = {
            ios: !1,
            android: !1
        }, u = l.screen.width, p = l.screen.height, f = c.match(/(Android);?[\s\/]+([\d.]+)?/), m = c.match(/(iPad).*OS\s([\d_]+)/), a = c.match(/(iPod)(.*OS\s([\d_]+))?/), o = !m && c.match(/(iPhone\sOS|iOS)\s([\d_]+)/), l = "Win32" === h, h = "MacIntel" === h, !m && h && r.touch && 0 <= ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(u + "x" + p) && ((m = c.match(/(Version)\/([\d.]+)/)) || (m = [0, 1, "13_0_0"]), h = !1), f && !l && (d.os = "android", d.android = !0), (m || o || a) && (d.os = "ios", d.ios = !0), y = d), y), g.browser = (_ || (b = K(), _ = {
            isEdge: !!b.navigator.userAgent.match(/Edge/g),
            isSafari: 0 <= (d = b.navigator.userAgent.toLowerCase()).indexOf("safari") && d.indexOf("chrome") < 0 && d.indexOf("android") < 0,
            isWebView: /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(b.navigator.userAgent)
        }), _), g.eventsListeners = {}, g.eventsAnyListeners = [], void 0 === g.modules && (g.modules = {}), Object.keys(g.modules).forEach(function(t) {
            var e = g.modules[t];
        ...
        var v, b = Q({}, H);
        return g.useParams(b), g.params = Q({}, b, W, i), g.originalParams = Q({}, g.params), g.passedParams = Q({}, i), g.params && g.params.on && Object.keys(g.params.on).forEach(function(t) {
            g.on(t, g.params.on[t])
        }), g.params && g.params.onAny && g.onAny(g.params.onAny), g.$ = k, Q(g, {
            el: v,
            classNames: [],
            slides: k(),
            slidesGrid: [],
            ...
            touchEvents: (b = ["mousedown", "mousemove", "mouseup"], g.support.pointerEvents && (b = ["pointerdown", "pointermove", "pointerup"]), g.touchEventsTouch = {
    ...
    var B = {
            update: function(t) {
                ...
                if (Q(e.virtual, {
                    ...
                    }), c === m && d === g && !t) return e.slidesGrid !== p && v !== i && e.slides.css(h, v + "px"), void e.updateProgress();
                if (e.params.virtual.renderExternal) return e.params.virtual.renderExternal.call(e, {
                    offset: v,
                    from: m,
                    to: g,
                    slides: function() {
                        for (var t = [], e = m; e <= g; e += 1) t.push(u[e]);
                        return t
                    }()
                ...
                if (t) e.$wrapperEl.find("." + e.params.slideClass).remove();
                    ...
                    for (var w = c; w <= d; w += 1)(w < m || g < w) && e.$wrapperEl.find("." + e.params.slideClass + '[data-swiper-slide-index="' + w + '"]').remove();
                for (var x = 0; x < u.length; x += 1) m <= x && x <= g && (void 0 === d || t ? _.push(x) : (d < x && _.push(x), x < c && y.push(x)));
            ...
            renderSlide: function(t, e) {
                ...
                t = i.renderSlide ? k(i.renderSlide.call(this, t, e)) : k('<div class="' + this.params.slideClass + '" data-swiper-slide-index="' + e + '">' + t + "</div>");
        ...
        S = {
            ...
            on: {
                beforeInit: function(t) {
                    var e;
                    t.params.virtual.enabled && (t.classNames.push(t.params.containerModifierClass + "virtual"), Q(t.params, e = {
                        watchSlidesProgress: !0
                    }), Q(t.originalParams, e), t.params.initialSlide || t.virtual.update())
                },
        ...
        Y = {
            handle: function(t) {
                var e = this,
                    ...
                    n = e.rtlTranslate,
                    a = t,
                    o = (a = a.originalEvent ? a.originalEvent : a).keyCode || a.charCode,
                    ...
                    t = 38 === o,
                    r = 40 === o;
                if (!e.allowSlideNext && (e.isHorizontal() && d || e.isVertical() && r || h)) return !1;
                if (!e.allowSlidePrev && (e.isHorizontal() && c || e.isVertical() && t || l)) return !1;
                if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || s.activeElement && s.activeElement.nodeName && ("input" === s.activeElement.nodeName.toLowerCase() || "textarea" === s.activeElement.nodeName.toLowerCase()))) {
                    if (e.params.keyboard.onlyInViewport && (l || h || c || d || t || r)) {
                        ...
                        for (var m = [
                            ...
                            var v = m[g];
                            0 <= v[0] && v[0] <= p && 0 <= v[1] && v[1] <= f && (0 === v[0] && 0 === v[1] || (u = !0))
                        }
                        if (!u) return
                    }
                    e.isHorizontal() ? ((l || h || c || d) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), ((h || d) && !n || (l || c) && n) && e.slideNext(), ((l || c) && !n || (h || d) && n) && e.slidePrev()) : ((l || h || t || r) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), (h || r) && e.slideNext(), (l || t) && e.slidePrev()), e.emit("keyPress", o)
                }
            },
            enable: function() {
                var t = b();
                this.keyboard.enabled || (k(t).on("keydown", this.keyboard.handle), this.keyboard.enabled = !0)
            },
            disable: function() {
                var t = b();
                this.keyboard.enabled && (k(t).off("keydown", this.keyboard.handle), this.keyboard.enabled = !1)
            }
        },
        I = {
            name: "keyboard",
        ...
        $ = {
            ...
            normalize: function(t) {
                var e = 0,
                    ...
                    s = 0,
                    n = 0;
                return "detail" in t && (i = t.detail), "wheelDelta" in t && (i = -t.wheelDelta / 120), "wheelDeltaY" in t && (i = -t.wheelDeltaY / 120), "wheelDeltaX" in t && (e = -t.wheelDeltaX / 120), "axis" in t && t.axis === t.HORIZONTAL_AXIS && (e = i, i = 0), s = 10 * e, n = 10 * i, "deltaY" in t && (n = t.deltaY), "deltaX" in t && (s = t.deltaX), t.shiftKey && !s && (s = n, n = 0), (s || n) && t.deltaMode && (1 === t.deltaMode ? (s *= 40, n *= 40) : (s *= 800, n *= 800)), {
                    spinX: e = s && !e ? s < 1 ? -1 : 1 : e,
                    spinY: i = n && !i ? n < 1 ? -1 : 1 : i,
                    pixelX: s,
                    pixelY: n
                }
            },
            ...
            handle: function(t) {
                ...
                var n = i.$el;
                if ("container" !== i.params.mousewheel.eventsTarget && (n = k(i.params.mousewheel.eventsTarget)), !i.mouseEntered && !n[0].contains(e.target) && !s.releaseOnEdges) return !0;
                ...
                if (0 === a) return !0;
                s.invert && (a = -a);
                o = i.getTranslate() + a * s.sensitivity;
                if ((o = o >= i.minTranslate() ? i.minTranslate() : o) <= i.maxTranslate() && (o = i.maxTranslate()), (i.params.loop || o !== i.minTranslate() && o !== i.maxTranslate()) && i.params.nested && e.stopPropagation(), i.params.freeMode) {
                    var r = {
                            time: E(),
                            delta: Math.abs(a),
                    ...
                    if (!o) {
                        ...
                        if ((c = c >= i.minTranslate() ? i.minTranslate() : c) <= i.maxTranslate() && (c = i.maxTranslate()), i.setTransition(0), i.setTranslate(c), i.updateProgress(), i.updateActiveIndex(), i.updateSlidesClasses(), (!n && i.isBeginning || !s && i.isEnd) && i.updateSlidesClasses(), i.params.freeModeSticky && (clearTimeout(i.mousewheel.timeout), i.mousewheel.timeout = void 0, 15 <= (l = i.mousewheel.recentWheelEvents).length && l.shift(), n = l.length ? l[l.length - 1] : void 0, s = l[0], l.push(r), n && (r.delta > n.delta || r.direction !== n.direction) ? l.splice(0) : 15 <= l.length && r.time - s.time < 500 && 1 <= s.delta - r.delta && r.delta <= 6 && (h = 0 < a ? .8 : .2, i.mousewheel.lastEventBeforeSnap = r, l.splice(0), i.mousewheel.timeout = T(function() {
                            ...
                            }, 500))), o || i.emit("scroll", e), i.params.autoplay && i.params.autoplayDisableOnInteraction && i.autoplay.start(), c === i.minTranslate() || c === i.maxTranslate()) return !0
                    }
                } else {
                    c = {
                        time: E(),
                    ...
                    if (a.push(c), (!t || c.direction !== t.direction || c.delta > t.delta || c.time > t.time + 150) && i.mousewheel.animateSlider(c), i.mousewheel.releaseScroll(c)) return !0
                }
            ...
            animateSlider: function(t) {
                var e = this,
                    i = K();
                return !(this.params.mousewheel.thresholdDelta && t.delta < this.params.mousewheel.thresholdDelta || this.params.mousewheel.thresholdTime && E() - e.mousewheel.lastScrollTime < this.params.mousewheel.thresholdTime || !(6 <= t.delta && E() - e.mousewheel.lastScrollTime < 60) && (t.direction < 0 ? e.isEnd && !e.params.loop || e.animating || (e.slideNext(), e.emit("scroll", t.raw)) : e.isBeginning && !e.params.loop || e.animating || (e.slidePrev(), e.emit("scroll", t.raw)), e.mousewheel.lastScrollTime = (new i.Date).getTime(), 1))
            },
            ...
            enable: function() {
                ...
                var i = t.$el;
                return (i = "container" !== t.params.mousewheel.eventsTarget ? k(t.params.mousewheel.eventsTarget) : i).on("mouseenter", t.mousewheel.handleMouseEnter), i.on("mouseleave", t.mousewheel.handleMouseLeave), i.on(e, t.mousewheel.handle), t.mousewheel.enabled = !0
            },
            disable: function() {
                var t = $.event();
                ...
                var e = this.$el;
                return (e = "container" !== this.params.mousewheel.eventsTarget ? k(this.params.mousewheel.eventsTarget) : e).off(t, this.mousewheel.handle), !(this.mousewheel.enabled = !1)
            }
        },
        j = {
            update: function() {
            ...
            init: function() {
                ...
                (s.nextEl || s.prevEl) && (s.nextEl && (t = k(s.nextEl), i.params.uniqueNavElements && "string" == typeof s.nextEl && 1 < t.length && 1 === i.$el.find(s.nextEl).length && (t = i.$el.find(s.nextEl))), s.prevEl && (e = k(s.prevEl), i.params.uniqueNavElements && "string" == typeof s.prevEl && 1 < e.length && 1 === i.$el.find(s.prevEl).length && (e = i.$el.find(s.prevEl))), t && 0 < t.length && t.on("click", i.navigation.onNextClick), e && 0 < e.length && e.on("click", i.navigation.onPrevClick), Q(i.navigation, {
                    $nextEl: t,
                    nextEl: t && t[0],
                    $prevEl: e,
                    prevEl: e && e[0]
        ...
        q = {
            update: function() {
                ...
                if (i.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                    var s, n = (t.virtual && t.params.virtual.enabled ? t.virtual : t).slides.length,
                        a = t.pagination.$el,
                        o = t.params.loop ? Math.ceil((n - 2 * t.loopedSlides) / t.params.slidesPerGroup) : t.snapGrid.length;
                    if (t.params.loop ? ((s = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup)) > n - 1 - 2 * t.loopedSlides && (s -= n - 2 * t.loopedSlides), o - 1 < s && (s -= o), s < 0 && "bullets" !== t.params.paginationType && (s = o + s)) : s = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === i.type && t.pagination.bullets && 0 < t.pagination.bullets.length) {
                        var r, l, h, c, d, u = t.pagination.bullets;
                        if (i.dynamicBullets && (t.pagination.bulletSize = u.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0), a.css(t.isHorizontal() ? "width" : "height", t.pagination.bulletSize * (i.dynamicMainBullets + 4) + "px"), 1 < i.dynamicMainBullets && void 0 !== t.previousIndex && (t.pagination.dynamicBulletIndex += s - t.previousIndex, t.pagination.dynamicBulletIndex > i.dynamicMainBullets - 1 ? t.pagination.dynamicBulletIndex = i.dynamicMainBullets - 1 : t.pagination.dynamicBulletIndex < 0 && (t.pagination.dynamicBulletIndex = 0)), r = s - t.pagination.dynamicBulletIndex, h = ((l = r + (Math.min(u.length, i.dynamicMainBullets) - 1)) + r) / 2), u.removeClass(i.bulletActiveClass + " " + i.bulletActiveClass + "-next " + i.bulletActiveClass + "-next-next " + i.bulletActiveClass + "-prev " + i.bulletActiveClass + "-prev-prev " + i.bulletActiveClass + "-main"), 1 < a.length) u.each(function(t) {
                            var e = k(t),
                                t = e.index();
                            t === s && e.addClass(i.bulletActiveClass), i.dynamicBullets && (r <= t && t <= l && e.addClass(i.bulletActiveClass + "-main"), t === r && e.prev().addClass(i.bulletActiveClass + "-prev").prev().addClass(i.bulletActiveClass + "-prev-prev"), t === l && e.next().addClass(i.bulletActiveClass + "-next").next().addClass(i.bulletActiveClass + "-next-next"))
                        });
                        else {
                            var p = u.eq(s),
                                f = p.index();
                            if (p.addClass(i.bulletActiveClass), i.dynamicBullets) {
                                for (var n = u.eq(r), p = u.eq(l), m = r; m <= l; m += 1) u.eq(m).addClass(i.bulletActiveClass + "-main");
                                if (t.params.loop)
                                    ...
                                    } else n.prev().addClass(i.bulletActiveClass + "-prev").prev().addClass(i.bulletActiveClass + "-prev-prev"), p.next().addClass(i.bulletActiveClass + "-next").next().addClass(i.bulletActiveClass + "-next-next");
                                else n.prev().addClass(i.bulletActiveClass + "-prev").prev().addClass(i.bulletActiveClass + "-prev-prev"), p.next().addClass(i.bulletActiveClass + "-next").next().addClass(i.bulletActiveClass + "-next-next")
                            }
                        }
                        i.dynamicBullets && (d = Math.min(u.length, i.dynamicMainBullets + 4), c = (t.pagination.bulletSize * d - t.pagination.bulletSize) / 2 - h * t.pagination.bulletSize, d = e ? "right" : "left", u.css(t.isHorizontal() ? d : "top", c + "px"))
                    }
                    "fraction" === i.type && (a.find("." + i.currentClass).text(i.formatFractionCurrent(s + 1)), a.find("." + i.totalClass).text(i.formatFractionTotal(o))), "progressbar" === i.type && (h = i.progressbarOpposite ? t.isHorizontal() ? "vertical" : "horizontal" : t.isHorizontal() ? "horizontal" : "vertical", e = (s + 1) / o, c = d = 1, "horizontal" == h ? d = e : c = e, a.find("." + i.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + d + ") scaleY(" + c + ")").transition(t.params.speed)), "custom" === i.type && i.renderCustom ? (a.html(i.renderCustom(t, s + 1, o)), t.emit("paginationRender", a[0])) : t.emit("paginationUpdate", a[0]), a[t.params.watchOverflow && t.isLocked ? "addClass" : "removeClass"](i.lockClass)
                }
            },
            render: function() {
                var t = this,
                ...
                if (e.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                    var i = (t.virtual && t.params.virtual.enabled ? t.virtual : t).slides.length,
                        ...
                        n = "";
                    if ("bullets" === e.type) {
                        var a = t.params.loop ? Math.ceil((i - 2 * t.loopedSlides) / t.params.slidesPerGroup) : t.snapGrid.length;
                        t.params.freeMode && !t.params.loop && i < a && (a = i);
                        for (var o = 0; o < a; o += 1) e.renderBullet ? n += e.renderBullet.call(t, o, e.bulletClass) : n += "<" + e.bulletElement + ' class="' + e.bulletClass + '"></' + e.bulletElement + ">";
                        s.html(n), t.pagination.bullets = s.find("." + e.bulletClass.replace(/ /g, "."))
                    }
            ...
            init: function() {
                ...
                !i.el || 0 !== (t = k(i.el)).length && (e.params.uniqueNavElements && "string" == typeof i.el && 1 < t.length && (t = e.$el.find(i.el)), "bullets" === i.type && i.clickable && t.addClass(i.clickableClass), t.addClass(i.modifierClass + i.type), "bullets" === i.type && i.dynamicBullets && (t.addClass("" + i.modifierClass + i.type + "-dynamic"), e.pagination.dynamicBulletIndex = 0, i.dynamicMainBullets < 1 && (i.dynamicMainBullets = 1)), "progressbar" === i.type && i.progressbarOpposite && t.addClass(i.progressbarOppositeClass), i.clickable && t.on("click", "." + i.bulletClass.replace(/ /g, "."), function(t) {
                    t.preventDefault();
                    t = k(this).index() * e.params.slidesPerGroup;
            ...
            destroy: function() {
                ...
                e.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length && ((t = this.pagination.$el).removeClass(e.hiddenClass), t.removeClass(e.modifierClass + e.type), this.pagination.bullets && this.pagination.bullets.removeClass(e.bulletActiveClass), e.clickable && t.off("click", "." + e.bulletClass.replace(/ /g, ".")))
            }
        },
        X = {
            ...
            updateSize: function() {
                ...
                r.params.scrollbar.el && r.scrollbar.el && (e = (t = r.scrollbar).$dragEl, i = t.$el, e[0].style.width = "", e[0].style.height = "", s = r.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight, a = (n = r.size / r.virtualSize) * (s / r.size), o = "auto" === r.params.scrollbar.dragSize ? s * n : parseInt(r.params.scrollbar.dragSize, 10), r.isHorizontal() ? e[0].style.width = o + "px" : e[0].style.height = o + "px", i[0].style.display = 1 <= n ? "none" : "", r.params.scrollbar.hide && (i[0].style.opacity = 0), Q(t, {
                    trackSize: s,
                    divider: n,
                    moveDivider: a,
                    dragSize: o
            ...
            setDragPosition: function(t) {
                var e = this,
                    ...
                    o = i.trackSize,
                    r = i.dragStartPos,
                    a = (i.getPointerPosition(t) - n.offset()[e.isHorizontal() ? "left" : "top"] - (null !== r ? r : a / 2)) / (o - a);
                a = Math.max(Math.min(a, 1), 0), s && (a = 1 - a);
            ...
            onDragStart: function(t) {
                var e = this,
                    ...
                    a = s.$el,
                    o = s.$dragEl;
                e.scrollbar.isTouched = !0, e.scrollbar.dragStartPos = t.target === o[0] || t.target === o ? s.getPointerPosition(t) - t.target.getBoundingClientRect()[e.isHorizontal() ? "left" : "top"] : null, t.preventDefault(), t.stopPropagation(), n.transition(100), o.transition(100), s.setDragPosition(t), clearTimeout(e.scrollbar.dragTimeout), a.transition(0), i.hide && a.css("opacity", 1), e.params.cssMode && e.$wrapperEl.css("scroll-snap-type", "none"), e.emit("scrollbarDragStart", t)
            },
            ...
            onDragEnd: function(t) {
                var e = this,
                    ...
                    n = e.$wrapperEl,
                    a = s.$el;
                e.scrollbar.isTouched && (e.scrollbar.isTouched = !1, e.params.cssMode && (e.$wrapperEl.css("scroll-snap-type", ""), n.transition("")), i.hide && (clearTimeout(e.scrollbar.dragTimeout), e.scrollbar.dragTimeout = T(function() {
                    a.css("opacity", 0), a.transition(400)
                }, 1e3)), e.emit("scrollbarDragEnd", t), i.snapOnRelease && e.slideToClosest())
            },
            enableDraggable: function() {
                var t, e, i, s, n, a, o, r = this;
                r.params.scrollbar.el && (t = b(), a = r.scrollbar, e = r.touchEventsTouch, i = r.touchEventsDesktop, o = r.params, s = r.support, n = a.$el[0], a = !(!s.passiveListener || !o.passiveListeners) && {
                    passive: !1,
                    capture: !1
                }, o = !(!s.passiveListener || !o.passiveListeners) && {
                    passive: !0,
                    capture: !1
                }, n && (s.touch ? (n.addEventListener(e.start, r.scrollbar.onDragStart, a), n.addEventListener(e.move, r.scrollbar.onDragMove, a), n.addEventListener(e.end, r.scrollbar.onDragEnd, o)) : (n.addEventListener(i.start, r.scrollbar.onDragStart, a), t.addEventListener(i.move, r.scrollbar.onDragMove, a), t.addEventListener(i.end, r.scrollbar.onDragEnd, o))))
            },
            disableDraggable: function() {
                ...
                r.params.scrollbar.el && (t = b(), a = r.scrollbar, e = r.touchEventsTouch, i = r.touchEventsDesktop, o = r.params, s = r.support, n = a.$el[0], a = !(!s.passiveListener || !o.passiveListeners) && {
                    ...
                    passive: !0,
                    capture: !1
                }, n && (s.touch ? (n.removeEventListener(e.start, r.scrollbar.onDragStart, a), n.removeEventListener(e.move, r.scrollbar.onDragMove, a), n.removeEventListener(e.end, r.scrollbar.onDragEnd, o)) : (n.removeEventListener(i.start, r.scrollbar.onDragStart, a), t.removeEventListener(i.move, r.scrollbar.onDragMove, a), t.removeEventListener(i.end, r.scrollbar.onDragEnd, o))))
            },
            init: function() {
                var t, e, i, s;
                this.params.scrollbar.el && (t = this.scrollbar, s = this.$el, i = k((e = this.params.scrollbar).el), 0 === (s = (i = this.params.uniqueNavElements && "string" == typeof e.el && 1 < i.length && 1 === s.find(e.el).length ? s.find(e.el) : i).find("." + this.params.scrollbar.dragClass)).length && (s = k('<div class="' + this.params.scrollbar.dragClass + '"></div>'), i.append(s)), Q(t, {
                    $el: i,
                    el: i[0],
                    $dragEl: s,
                    dragEl: s[0]
        ...
        V = {
            setTransform: function(t, e) {
                var i = this.rtl,
                    ...
                    t = s.attr("data-swiper-parallax-scale"),
            ...
            setTranslate: function() {
                ...
                t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(t) {
                    ...
                    var i = t.progress;
                    1 < s.params.slidesPerGroup && "auto" !== s.params.slidesPerView && (i += Math.ceil(e / 2) - n * (a.length - 1)), i = Math.min(Math.max(i, -1), 1), k(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(t) {
        ...
        G = {
            ...
            onGestureStart: function(t) {
                ...
                if (s.fakeGestureTouched = !1, s.fakeGestureMoved = !1, !e.gestures) {
                    ...
                    s.fakeGestureTouched = !0, n.scaleStart = G.getDistanceBetweenTouches(t)
                }
                n.$slideEl && n.$slideEl.length || (n.$slideEl = k(t.target).closest("." + this.params.slideClass), 0 === n.$slideEl.length && (n.$slideEl = this.slides.eq(this.activeIndex)), n.$imageEl = n.$slideEl.find("img, svg, canvas, picture, .swiper-zoom-target"), n.$imageWrapEl = n.$imageEl.parent("." + i.containerClass), n.maxRatio = n.$imageWrapEl.attr("data-swiper-zoom") || i.maxRatio, 0 !== n.$imageWrapEl.length) ? (n.$imageEl && n.$imageEl.transition(0), this.zoom.isScaling = !0) : n.$imageEl = void 0
            },
            onGestureChange: function(t) {
                ...
                if (!e.gestures) {
                    ...
                    s.fakeGestureMoved = !0, n.scaleMove = G.getDistanceBetweenTouches(t)
                }
            ...
            enable: function() {
                var t, e, i, s = this,
                    n = s.support,
                    a = s.zoom;
                a.enabled || (a.enabled = !0, t = !("touchstart" !== s.touchEvents.start || !n.passiveListener || !s.params.passiveListeners) && {
                    passive: !0,
                    capture: !1
                }, e = !n.passiveListener || {
                    passive: !1,
                    capture: !0
                }, i = "." + s.params.slideClass, s.zoom.passiveListener = t, s.zoom.slideSelector = i, n.gestures ? (s.$wrapperEl.on(s.touchEvents.start, s.zoom.enableGestures, t), s.$wrapperEl.on(s.touchEvents.end, s.zoom.disableGestures, t)) : "touchstart" === s.touchEvents.start && (s.$wrapperEl.on(s.touchEvents.start, i, a.onGestureStart, t), s.$wrapperEl.on(s.touchEvents.move, i, a.onGestureChange, e), s.$wrapperEl.on(s.touchEvents.end, i, a.onGestureEnd, t), s.touchEvents.cancel && s.$wrapperEl.on(s.touchEvents.cancel, i, a.onGestureEnd, t)), s.$wrapperEl.on(s.touchEvents.move, "." + s.params.zoom.containerClass, a.onTouchMove, e))
            },
            disable: function() {
                var t, e, i, s, n = this,
                    a = n.zoom;
                a.enabled && (t = n.support, n.zoom.enabled = !1, e = !("touchstart" !== n.touchEvents.start || !t.passiveListener || !n.params.passiveListeners) && {
                    passive: !0,
                    capture: !1
                }, i = !t.passiveListener || {
                    passive: !1,
                    capture: !0
                }, s = "." + n.params.slideClass, t.gestures ? (n.$wrapperEl.off(n.touchEvents.start, n.zoom.enableGestures, e), n.$wrapperEl.off(n.touchEvents.end, n.zoom.disableGestures, e)) : "touchstart" === n.touchEvents.start && (n.$wrapperEl.off(n.touchEvents.start, s, a.onGestureStart, e), n.$wrapperEl.off(n.touchEvents.move, s, a.onGestureChange, i), n.$wrapperEl.off(n.touchEvents.end, s, a.onGestureEnd, e), n.touchEvents.cancel && n.$wrapperEl.off(n.touchEvents.cancel, s, a.onGestureEnd, e)), n.$wrapperEl.off(n.touchEvents.move, "." + n.params.zoom.containerClass, a.onTouchMove, i))
            }
        },
        U = {
            loadInSlide: function(t, l) {
                ...
                var h, c = this,
                    d = c.params.lazy;
                void 0 !== t && 0 !== c.slides.length && (t = (h = c.virtual && c.params.virtual.enabled ? c.$wrapperEl.children("." + c.params.slideClass + '[data-swiper-slide-index="' + t + '"]') : c.slides.eq(t)).find("." + d.elementClass + ":not(." + d.loadedClass + "):not(." + d.loadingClass + ")"), !h.hasClass(d.elementClass) || h.hasClass(d.loadedClass) || h.hasClass(d.loadingClass) || t.push(h[0]), 0 !== t.length && t.each(function(t) {
                    var i = k(t);
            ...
            load: function() {
                ...
                function h(t) {
                    return a ? k(t).attr("data-swiper-slide-index") : k(t).index()
                }
                if ("auto" === r && (r = 0), e.lazy.initialImageLoaded || (e.lazy.initialImageLoaded = !0), e.params.watchSlidesVisibility) i.children("." + s.slideVisibleClass).each(function(t) {
                    t = a ? k(t).attr("data-swiper-slide-index") : k(t).index();
                    e.lazy.loadInSlide(t)
                });
                else if (1 < r)
                    for (var c = t; c < t + r; c += 1) l(c) && e.lazy.loadInSlide(c);
                else e.lazy.loadInSlide(t);
                if (o.loadPrevNext)
                    if (1 < r || o.loadPrevNextAmount && 1 < o.loadPrevNextAmount) {
                        for (var d = o.loadPrevNextAmount, o = r, u = Math.min(t + o + Math.max(d, o), n.length), d = Math.max(t - Math.max(o, d), 0), p = t + r; p < u; p += 1) l(p) && e.lazy.loadInSlide(p);
                        for (var f = d; f < t; f += 1) l(f) && e.lazy.loadInSlide(f)
                    } else {
                        d = i.children("." + s.slideNextClass);
                        0 < d.length && e.lazy.loadInSlide(h(d));
                        d = i.children("." + s.slidePrevClass);
                        0 < d.length && e.lazy.loadInSlide(h(d))
                    }
            },
            checkInViewOnLoad: function() {
                var t = K(),
                    e = this;
                if (e && !e.destroyed) {
                    var i = e.params.lazy.scrollingElement ? k(e.params.lazy.scrollingElement) : k(t),
                        s = i[0] === t,
                        n = s ? t.innerWidth : i[0].offsetWidth,
                        a = s ? t.innerHeight : i[0].offsetHeight,
                        t = e.$el.offset(),
                        o = !1;
                    e.rtlTranslate && (t.left -= e.$el[0].scrollLeft);
                    for (var r = [
                            [t.left, t.top],
                        ...
                        var h = r[l];
                        0 <= h[0] && h[0] <= n && 0 <= h[1] && h[1] <= a && (0 === h[0] && 0 === h[1] || (o = !0))
                    }
                    o ? (e.lazy.load(), i.off("scroll", e.lazy.checkInViewOnLoad)) : e.lazy.scrollHandlerAttached || (e.lazy.scrollHandlerAttached = !0, i.on("scroll", e.lazy.checkInViewOnLoad))
                }
            }
        },
        Z = {
            ...
            setTranslate: function(t, e) {
                ...
                if (Array.isArray(a))
                    for (var l = 0; l < a.length; l += 1) a[l] !== e && a[l] instanceof o && r(a[l]);
                else a instanceof o && e !== a && r(a)
            },
            setTransition: function(e, t) {
                ...
                if (Array.isArray(a))
                    for (i = 0; i < a.length; i += 1) a[i] !== t && a[i] instanceof n && o(a[i]);
                else a instanceof n && t !== a && o(a)
            }
        },
        J = {
            getRandomNumber: function(t) {
                return "x".repeat(t = void 0 === t ? 16 : t).replace(/x/g, function() {
            ...
            updateNavigation: function() {
                var t, e, i = this;
                !i.params.loop && i.navigation && (t = (e = i.navigation).$nextEl, (e = e.$prevEl) && 0 < e.length && (i.isBeginning ? (i.a11y.disableEl(e), i.a11y.makeElNotFocusable(e)) : (i.a11y.enableEl(e), i.a11y.makeElFocusable(e))), t && 0 < t.length && (i.isEnd ? (i.a11y.disableEl(t), i.a11y.makeElNotFocusable(t)) : (i.a11y.enableEl(t), i.a11y.makeElFocusable(t))))
            },
            ...
            init: function() {
                ...
                var s, n, a = e.$wrapperEl,
                    o = a.attr("id") || "swiper-wrapper-" + e.a11y.getRandomNumber(16);
                e.a11y.addElId(a, o), i = e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite", e.a11y.addElLive(a, i), t.itemRoleDescriptionMessage && e.a11y.addElRoleDescription(k(e.slides), t.itemRoleDescriptionMessage), e.a11y.addElRole(k(e.slides), "group"), e.slides.each(function(t) {
                    t = k(t);
        ...
        tt = {
            ...
            getPathValues: function(t) {
                var e = K(),
                    t = (t ? new URL(t) : e.location).pathname.slice(1).split("/").filter(function(t) {
                        return "" !== t
                    }),
                    e = t.length;
                return {
            ...
            setHistory: function(t, e) {
                var i, s = K();
                this.history.initialized && this.params.history.enabled && (i = this.params.url ? new URL(this.params.url) : s.location, e = this.slides.eq(e), e = tt.slugify(e.attr("data-history")), i.pathname.includes(t) || (e = t + "/" + e), (t = s.history.state) && t.value === e || (this.params.history.replaceState ? s.history.replaceState({
                    value: e
                ...
                if (!(!t.params.hashNavigation.enabled || t.params.history && t.params.history.enabled)) {
                    ...
                    if (s)
                        for (var n = 0, a = t.slides.length; n < a; n += 1) {
                            var o = t.slides.eq(n);
                            (o.attr("data-hash") || o.attr("data-history")) !== s || o.hasClass(t.params.slideDuplicateClass) || (o = o.index(), t.slideTo(o, 0, t.params.runCallbacksOnInit, !0))
                        }
                    t.params.hashNavigation.watchState && k(i).on("hashchange", t.hashNavigation.onHashCange)
                }
            },
            destroy: function() {
                var t = K();
                this.params.hashNavigation.watchState && k(t).off("hashchange", this.hashNavigation.onHashCange)
            }
        },
        it = {
            run: function() {
            ...
            onTransitionEnd: function(t) {
                var e = this;
                e && !e.destroyed && e.$wrapperEl && t.target === e.$wrapperEl[0] && (e.$wrapperEl[0].removeEventListener("transitionend", e.autoplay.onTransitionEnd), e.$wrapperEl[0].removeEventListener("webkitTransitionEnd", e.autoplay.onTransitionEnd), e.autoplay.paused = !1, e.autoplay.running ? e.autoplay.run() : e.autoplay.stop())
            }
        },
        st = {
            setTranslate: function() {
        ...
        nt = {
            setTranslate: function() {
                var t, e = this,
                    ...
                    p = 0;
                c.shadow && (d ? (0 === (t = s.find(".swiper-cube-shadow")).length && (t = k('<div class="swiper-cube-shadow"></div>'), s.append(t)), t.css({
                    height: a + "px"
                })) : 0 === (t = i.find(".swiper-cube-shadow")).length && (t = k('<div class="swiper-cube-shadow"></div>'), i.append(t)));
                for (var f, m = 0; m < n.length; m += 1) {
                    var g = n.eq(m),
                        v = m,
                    ...
                    var _ = Math.max(Math.min(g[0].progress, 1), -1),
                        ...
                        x = 0,
                        C = 0;
                    v % 4 == 0 ? (w = 4 * -y * l, C = 0) : (v - 1) % 4 == 0 ? (w = 0, C = 4 * -y * l) : (v - 2) % 4 == 0 ? (w = l + 4 * y * l, C = l) : (v - 3) % 4 == 0 && (w = -l, C = 3 * l + 4 * l * y), r && (w = -w), d || (x = w, w = 0), _ <= 1 && -1 < _ && (p = r ? 90 * -v - 90 * _ : 90 * v + 90 * _), g.transform("rotateX(" + (d ? 0 : -b) + "deg) rotateY(" + (d ? b : 0) + "deg) translate3d(" + w + "px, " + x + "px, " + C + "px)"), c.slideShadows && (x = d ? g.find(".swiper-slide-shadow-left") : g.find(".swiper-slide-shadow-top"), C = d ? g.find(".swiper-slide-shadow-right") : g.find(".swiper-slide-shadow-bottom"), 0 === x.length && (x = k('<div class="swiper-slide-shadow-' + (d ? "left" : "top") + '"></div>'), g.append(x)), 0 === C.length && (C = k('<div class="swiper-slide-shadow-' + (d ? "right" : "bottom") + '"></div>'), g.append(C)), x.length && (x[0].style.opacity = Math.max(-_, 0)), C.length && (C[0].style.opacity = Math.max(_, 0)))
                }
                s.css({
            ...
            setTranslate: function() {
                for (var t = this.slides, e = this.rtlTranslate, i = 0; i < t.length; i += 1) {
                    var s, n, a = t.eq(i),
                        ...
                        c = 0;
                    this.isHorizontal() ? e && (r = -r) : (c = h, l = -r, r = h = 0), a[0].style.zIndex = -Math.abs(Math.round(o)) + t.length, this.params.flipEffect.slideShadows && (s = this.isHorizontal() ? a.find(".swiper-slide-shadow-left") : a.find(".swiper-slide-shadow-top"), n = this.isHorizontal() ? a.find(".swiper-slide-shadow-right") : a.find(".swiper-slide-shadow-bottom"), 0 === s.length && (s = k('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'), a.append(s)), 0 === n.length && (n = k('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'), a.append(n)), s.length && (s[0].style.opacity = Math.max(-o, 0)), n.length && (n[0].style.opacity = Math.max(o, 0))), a.transform("translate3d(" + h + "px, " + c + "px, 0px) rotateX(" + l + "deg) rotateY(" + r + "deg)")
                }
            },
            setTransition: function(t) {
                var i, s = this,
        ...
        ot = {
            setTranslate: function() {
                for (var t = this.width, e = this.height, i = this.slides, s = this.slidesSizesGrid, n = this.params.coverflowEffect, a = this.isHorizontal(), o = this.translate, r = a ? t / 2 - o : e / 2 - o, l = a ? n.rotate : -n.rotate, h = n.depth, c = 0, d = i.length; c < d; c += 1) {
                    var u = i.eq(c),
                        p = s[c],
                        f = (r - u[0].swiperSlideOffset - p / 2) / p * n.modifier,
                        m = a ? l * f : 0,
                        g = a ? 0 : l * f,
                        v = -h * Math.abs(f),
                        b = n.stretch;
                    ...
                    var y = a ? 0 : b * f,
                        p = a ? b * f : 0,
                        b = 1 - (1 - n.scale) * Math.abs(f);
                    Math.abs(p) < .001 && (p = 0), Math.abs(y) < .001 && (y = 0), Math.abs(v) < .001 && (v = 0), Math.abs(m) < .001 && (m = 0), Math.abs(g) < .001 && (g = 0), Math.abs(b) < .001 && (b = 0), u.transform("translate3d(" + p + "px," + y + "px," + v + "px)  rotateX(" + g + "deg) rotateY(" + m + "deg) scale(" + b + ")"), u[0].style.zIndex = 1 - Math.abs(Math.round(f)), n.slideShadows && (m = a ? u.find(".swiper-slide-shadow-left") : u.find(".swiper-slide-shadow-top"), b = a ? u.find(".swiper-slide-shadow-right") : u.find(".swiper-slide-shadow-bottom"), 0 === m.length && (m = k('<div class="swiper-slide-shadow-' + (a ? "left" : "top") + '"></div>'), u.append(m)), 0 === b.length && (b = k('<div class="swiper-slide-shadow-' + (a ? "right" : "bottom") + '"></div>'), u.append(b)), m.length && (m[0].style.opacity = 0 < f ? f : 0), b.length && (b[0].style.opacity = 0 < -f ? -f : 0))
                }
            },
            setTransition: function(t) {
        ...
        rt = {
            init: function() {
                ...
                var i = t.constructor;
                return e.swiper instanceof i ? (t.thumbs.swiper = e.swiper, Q(t.thumbs.swiper.originalParams, {
                    watchSlidesProgress: !0,
                    slideToClickedSlide: !1
                }), Q(t.thumbs.swiper.params, {
                    watchSlidesProgress: !0,
                    slideToClickedSlide: !1
                })) : w(e.swiper) && (t.thumbs.swiper = new i(Q({}, e.swiper, {
            ...
            onThumbClick: function() {
                var t, e, i, s = this,
                    n = s.thumbs.swiper;
                n && (e = n.clickedIndex, (t = n.clickedSlide) && k(t).hasClass(s.params.thumbs.slideThumbActiveClass) || null == e || (i = n.params.loop ? parseInt(k(n.clickedSlide).attr("data-swiper-slide-index"), 10) : e, s.params.loop && (t = s.activeIndex, s.slides.eq(t).hasClass(s.params.slideDuplicateClass) && (s.loopFix(), s._clientLeft = s.$wrapperEl[0].clientLeft, t = s.activeIndex), n = s.slides.eq(t).prevAll('[data-swiper-slide-index="' + i + '"]').eq(0).index(), e = s.slides.eq(t).nextAll('[data-swiper-slide-index="' + i + '"]').eq(0).index(), i = void 0 === n || void 0 !== e && e - t < t - n ? e : n), s.slideTo(i)))
            },
            update: function(t) {
                var e = this,
                    i = e.thumbs.swiper;
                if (i) {
                    var s, n, a, o = "auto" === i.params.slidesPerView ? i.slidesPerViewDynamic() : i.params.slidesPerView,
                        r = e.params.thumbs.autoScrollOffset,
                        l = r && !i.params.loop;
                    e.realIndex === i.realIndex && !l || (s = i.activeIndex, a = i.params.loop ? (i.slides.eq(s).hasClass(i.params.slideDuplicateClass) && (i.loopFix(), i._clientLeft = i.$wrapperEl[0].clientLeft, s = i.activeIndex), a = i.slides.eq(s).prevAll('[data-swiper-slide-index="' + e.realIndex + '"]').eq(0).index(), n = i.slides.eq(s).nextAll('[data-swiper-slide-index="' + e.realIndex + '"]').eq(0).index(), n = void 0 === a ? n : void 0 === n ? a : n - s == s - a ? s : n - s < s - a ? n : a, e.activeIndex > e.previousIndex ? "next" : "prev") : (n = e.realIndex) > e.previousIndex ? "next" : "prev", l && (n += "next" === a ? r : -1 * r), i.visibleSlidesIndexes && i.visibleSlidesIndexes.indexOf(n) < 0 && (i.params.centeredSlides ? n = s < n ? n - Math.floor(o / 2) + 1 : n + Math.floor(o / 2) - 1 : s < n && (n = n - o + 1), i.slideTo(n, t ? 0 : void 0)));
                    var h = 1,
                        c = e.params.thumbs.slideThumbActiveClass;
                    if (1 < e.params.slidesPerView && !e.params.centeredSlides && (h = e.params.slidesPerView), e.params.thumbs.multipleActiveThumbs || (h = 1), h = Math.floor(h), i.slides.removeClass(c), i.params.loop || i.params.virtual && i.params.virtual.enabled)
                        for (var d = 0; d < h; d += 1) i.$wrapperEl.children('[data-swiper-slide-index="' + (e.realIndex + d) + '"]').addClass(c);
                    else
                        for (var u = 0; u < h; u += 1) i.slides.eq(e.realIndex + u).addClass(c)
                }
            }
        };
    return F.use([S, I, {
        ...
        on: {
            ...
            click: function(t, e) {
                var i, s = t.navigation,
                    n = s.$nextEl,
                    s = s.$prevEl;
                !t.params.navigation.hideOnClick || k(e.target).is(s) || k(e.target).is(n) || (n ? i = n.hasClass(t.params.navigation.hiddenClass) : s && (i = s.hasClass(t.params.navigation.hiddenClass)), !0 === i ? t.emit("navigationShow") : t.emit("navigationHide"), n && n.toggleClass(t.params.navigation.hiddenClass), s && s.toggleClass(t.params.navigation.hiddenClass))
            }
        }
    }, {
        name: "pagination",
        ...
        on: {
            ...
            click: function(t, e) {
                t.params.pagination.el && t.params.pagination.hideOnClick && 0 < t.pagination.$el.length && !k(e.target).hasClass(t.params.pagination.bulletClass) && (!0 === t.pagination.$el.hasClass(t.params.pagination.hiddenClass) ? t.emit("paginationShow") : t.emit("paginationHide"), t.pagination.$el.toggleClass(t.params.pagination.hiddenClass))
            }
        }
    }, {
        name: "scrollbar",
        ...
        on: {
            init: function(t) {
                t.params.autoplay.enabled && (t.autoplay.start(), b().addEventListener("visibilitychange", t.autoplay.onVisibilityChange))
            },
            ...
            destroy: function(t) {
                t.autoplay.running && t.autoplay.stop(), b().removeEventListener("visibilitychange", t.autoplay.onVisibilityChange)
            }
        }
    }, {
        name: "effect-fade",
        ...
        on: {
            beforeInit: function(t) {
                var e;
                "fade" === t.params.effect && (t.classNames.push(t.params.containerModifierClass + "fade"), Q(t.params, e = {
                    slidesPerView: 1,
                    slidesPerColumn: 1,
                    slidesPerGroup: 1,
                    watchSlidesProgress: !0,
        ...
        on: {
            beforeInit: function(t) {
                var e;
                "cube" === t.params.effect && (t.classNames.push(t.params.containerModifierClass + "cube"), t.classNames.push(t.params.containerModifierClass + "3d"), Q(t.params, e = {
                    slidesPerView: 1,
                    slidesPerColumn: 1,
                    slidesPerGroup: 1,
                    watchSlidesProgress: !0,
        ...
        on: {
            beforeInit: function(t) {
                var e;
                "flip" === t.params.effect && (t.classNames.push(t.params.containerModifierClass + "flip"), t.classNames.push(t.params.containerModifierClass + "3d"), Q(t.params, e = {
                    slidesPerView: 1,
                    slidesPerColumn: 1,
                    slidesPerGroup: 1,
                    watchSlidesProgress: !0,
    ...
    return c.fn.tilt = function(e) {
        ...
        return c.fn.tilt.destroy = function() {
            ...
            return c(this).each(function() {
                this.mousePositions = n.call(this), t.push(a.call(this))
            }), t
            ...
            this.settings = c.extend({
                ...
                c(t).data("settings", t.settings), t.settings.glare && function() {
                    ...
                    function() {
                        c(this).on("mousemove", r), c(this).on("mouseenter", o), this.settings.reset && c(this).on("mouseleave", l), this.settings.glare && c(window).on("resize", h.bind(this))
                    }.call(t)
            }, this.init()
        })
    }, c("[data-tilt]").tilt(), !0
...
function(t, e) {
    ...
    function c(t) {
        ...
        var e = d(t),
            ...
            s = e.overflowX,
            e = e.overflowY;
        return /(auto|scroll|overlay)/.test(i + e + s) ? t : c(h(t))
    }

    function u(t) {
        return 11 === t ? it : 10 !== t && it || st
    }
    ...
    function p(t) {
        ...
        var s = i && i.nodeName;
        return s && "BODY" !== s && "HTML" !== s ? -1 !== ["TH", "TD", "TABLE"].indexOf(i.nodeName) && "static" === d(i, "position") ? p(i) : i : (t ? t.ownerDocument : document).documentElement
    }
    ...
    function f(t, e) {
        ...
        if (t !== i && e !== i || s.contains(n)) return "BODY" === (n = (s = i).nodeName) || "HTML" !== n && p(s.firstElementChild) !== s ? p(i) : i;
        i = a(t);
        return i.host ? f(i.host, e) : f(t, a(e).host)
    }
    ...
    function s(t, e, i, s) {
        return $(e["offset" + t], e["scroll" + t], i["client" + t], i["offset" + t], i["scroll" + t], u(10) ? parseInt(i["offset" + t]) + parseInt(s["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(s["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0)
    }

    function g(t) {
        var e = t.body,
            i = t.documentElement,
            t = u(10) && getComputedStyle(i);
        return {
            height: s("Height", e, i, t),
            width: s("Width", e, i, t)
        }
    }
    ...
    function b(t) {
        var e = {};
        try {
            u(10) ? (e = t.getBoundingClientRect(), i = m(t, "top"), s = m(t, "left"), e.top += i, e.left += s, e.bottom += i, e.right += s) : e = t.getBoundingClientRect()
        } catch (t) {}
        var i = {
                left: e.left,
                top: e.top,
            ...
            e = s.width || t.clientWidth || i.right - i.left,
            s = s.height || t.clientHeight || i.bottom - i.top,
            e = t.offsetWidth - e,
            s = t.offsetHeight - s;
        return (e || s) && (e -= o(t = d(t), "x"), s -= o(t, "y"), i.width -= e, i.height -= s), v(i)
    }
    ...
    function y(t, e, i) {
        var s = !!(2 < arguments.length && void 0 !== i) && i,
            ...
            l = c(t),
            h = d(e),
            i = parseFloat(h.borderTopWidth, 10),
            t = parseFloat(h.borderLeftWidth, 10);
        s && a && (r.top = $(r.top, 0), r.left = $(r.left, 0));
        o = v({
            top: o.top - r.top - i,
        ...
        return o.marginTop = 0, o.marginLeft = 0, !n && a && (a = parseFloat(h.marginTop, 10), h = parseFloat(h.marginLeft, 10), o.top -= i - a, o.bottom -= i - a, o.left -= t - h, o.right -= t - h, o.marginTop = a, o.marginLeft = h), o = (n && !s ? e.contains(l) : e === l && "BODY" !== l.nodeName) ? function(t, e, i) {
            var s = !!(2 < arguments.length && void 0 !== i) && i,
                i = m(e, "top"),
                e = m(e, "left"),
                s = s ? -1 : 1;
    ...
    function _(t) {
        ...
        for (var e = t.parentElement; e && "none" === d(e, "transform");) e = e.parentElement;
        return e || document.documentElement
    }

    function w(t, e, i, s, n) {
        var a, o = !!(4 < arguments.length && void 0 !== n) && n,
            r = {
                top: 0,
                left: 0
            },
            n = o ? _(t) : f(t, e);
        "viewport" === s ? r = function(t, e) {
            var i = !!(1 < arguments.length && void 0 !== e) && e,
                s = t.ownerDocument.documentElement,
                n = y(t, s),
                a = $(s.clientWidth, window.innerWidth || 0),
                e = $(s.clientHeight, window.innerHeight || 0),
                t = i ? 0 : m(s),
                s = i ? 0 : m(s, "left");
            return v({
        ...
        }(n, o) : ("scrollParent" === s ? "BODY" === (a = c(h(e))).nodeName && (a = t.ownerDocument.documentElement) : a = "window" === s ? t.ownerDocument.documentElement : s, l = y(a, n, o), "HTML" !== a.nodeName || function t(e) {
            var i = e.nodeName;
            return "BODY" !== i && "HTML" !== i && ("fixed" === d(e, "position") || t(h(e)))
        }(n) ? r = l : (t = (n = g(t.ownerDocument)).height, n = n.width, r.top += l.top - l.marginTop, r.bottom = t + l.top, r.left += l.left - l.marginLeft, r.right = n + l.left));
    ...
    function k(t, e, i) {
        ...
        var s = x(t),
            ...
            t = a ? "height" : "width",
            a = a ? "width" : "height";
        return n[o] = e[o] + e[t] / 2 - s[t] / 2, n[r] = i === r ? e[r] - s[a] : e[C(r)], n
    }
    ...
    function E(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, i) {
            ...
            t.enabled && n(e) && (i.offsets.popper = v(i.offsets.popper), i.offsets.reference = v(i.offsets.reference), i = e(i, t))
        }), i
    }
    ...
    function e(t, e, i, s) {
        ...
        return function t(e, i, s, n) {
            ...
            e.addEventListener(i, s, {
                passive: !0
            }), a || t(c(e.parentNode), i, s, n), n.push(e)
    ...
    function z(t, e) {
        e = !!(1 < arguments.length && void 0 !== e) && e, t = ot.indexOf(t), t = ot.slice(t + 1).concat(ot.slice(0, t));
        ...
        return (-1 === e ? [i] : [i.slice(0, e).concat([i[e].split(t)[0]]), [i[e].split(t)[1]].concat(i.slice(e + 1))]).map(function(t, e) {
            ...
            return t.reduce(function(t, e) {
                ...
                return function(t, e, i, s) {
                    var n, a = +(o = t.match(/((?:\-|\+)?\d*\.?\d*)(.*)/))[1],
                        o = o[2];
                    if (!a) return t;
                    if (0 !== o.indexOf("%")) return "vh" !== o && "vw" !== o ? a : ("vh" === o ? $(document.documentElement.clientHeight, window.innerHeight || 0) : $(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * a;
                    switch (o) {
                        case "%p":
                            n = i;
                            break;
    ...
    function R(t, e) {
        ...
        function s(t) {
            var e, i, s, n, a, o, r = I = t,
                l = r.clientX,
                h = r.clientY;
            F.popperInstance && (e = Vt(F.popper), t = F.popperChildren.arrow ? 20 : 5, r = "left" === e || "right" === e, i = (e = "top" === e || "bottom" === e) ? $(t, l) : l, s = r ? $(t, h) : h, e && t < i && (i = B(l, window.innerWidth - t)), r && t < s && (s = B(h, window.innerHeight - t)), n = F.reference.getBoundingClientRect(), t = F.props.followCursor, a = "horizontal" === t, o = "vertical" === t, F.popperInstance.reference = {
                ...
                clientWidth: 0,
                clientHeight: 0
            }, F.popperInstance.scheduleUpdate())
        }

        function n(t) {
            if (w(), !F.state.isVisible) {
                if (F.props.target) return (i = Ht((e = t).target, F.props.target)) && !i._tippy && (R(i, j({}, F.props, {
                    target: "",
                    showOnInit: !0
                })), n(e)), 0;
                if (z = !0, F.props.wait) return F.props.wait(F, t);
                g() && document.addEventListener("mousemove", s);
                t = zt(F.props.delay, 0, q.delay);
        ...
        function a() {
            if (w(), !F.state.isVisible) return o();
            z = !1;
            var t = zt(F.props.delay, 1, q.delay);
        ...
        function o() {
            document.removeEventListener("mousemove", s), I = null
        }

        function r() {
            document.body.removeEventListener("mouseleave", a), document.removeEventListener("mousemove", H)
        }

        function l(t) {
            !F.state.isEnabled || f(t) || (F.state.isVisible || (M = t), "click" === t.type && !1 !== F.props.hideOnClick && F.state.isVisible ? a() : n(t))
        }

        function h(t) {
            var e = Nt(t.target, function(t) {
                    return t._tippy
                }),
                i = Ht(t.target, Tt.POPPER) === F.popper,
                e = e === F.reference;
            i || e || qt(Vt(F.popper), F.popper.getBoundingClientRect(), t, F.props) && (r(), a())
        }

        function c(t) {
            return f(t) ? void 0 : F.props.interactive ? (document.body.addEventListener("mouseleave", a), void document.addEventListener("mousemove", H)) : void a()
        }

        function d(t) {
            if (t.target === F.reference) {
                if (F.props.interactive) {
                    if (!t.relatedTarget) return;
                    if (Ht(t.relatedTarget, Tt.POPPER)) return
                }
                a()
            }
        }
        ...
        function u(t) {
            Ht(t.target, F.props.target) && n(t)
        }

        function p(t) {
            Ht(t.target, F.props.target) && a()
        }

        function f(t) {
            var e = -1 < t.type.indexOf("touch"),
                t = U && Zt && F.props.touchHold && !e,
                e = Zt && !F.props.touchHold && e;
            return t || e
        }

        function m() {
            var e = F.popperChildren.tooltip,
                t = F.props.popperOptions,
                i = Tt["round" === F.props.arrowType ? "ROUND_ARROW" : "ARROW"],
                s = e.querySelector(i),
                t = j({
                    placement: F.props.placement
                }, t || {}, {
                    modifiers: j({}, t ? t.modifiers : {}, {
                        arrow: j({
                            element: i
                        }, t && t.modifiers ? t.modifiers.arrow : {}),
                        flip: j({
                            enabled: F.props.flip,
                            padding: F.props.distance + 5,
                    ...
                    onCreate: function() {
                        e.style[Vt(F.popper)] = Xt(F.props.distance, q.distance), s && F.props.arrowTransform && Bt(s, F.props.arrowTransform)
                    },
                    onUpdate: function() {
                        var t = e.style;
                        t.top = "", t.bottom = "", t.left = "", t.right = "", t[Vt(F.popper)] = Xt(F.props.distance, q.distance), s && F.props.arrowTransform && Bt(s, F.props.arrowTransform)
                    }
                });
            return S || (S = new MutationObserver(function() {
                F.popperInstance.update()
            })).observe(W, {
                childList: !0,
                subtree: !0
            }), new ct(F.reference, F.popper, t)
        }

        function g() {
            return F.props.followCursor && !Zt && "focus" !== M.type
        }

        function v(t, i) {
            if (0 === t) return i();
            var s = F.popperChildren.tooltip,
                t = function t(e) {
                    e.target === s && (Ut(s, "remove", t), i())
                };
            Ut(s, "remove", O), Ut(s, "add", t), O = t
        }

        function b(t, e, i) {
            F.reference.addEventListener(t, e), i.push({
                eventType: t,
                handler: e
            })
        }
        ...
        function y() {
            L = F.props.trigger.trim().split(" ").reduce(function(t, e) {
                return "manual" === e || (F.props.target ? "mouseenter" === e ? (b("mouseover", u, t), b("mouseout", p, t)) : "focus" === e ? (b("focusin", u, t), b("focusout", p, t)) : "click" === e && b(e, u, t) : (b(e, l, t), F.props.touchHold && (b("touchstart", l, t), b("touchend", c, t)), "mouseenter" === e ? b("mouseleave", c, t) : "focus" === e && b(V ? "focusout" : "blur", d, t))), t
            }, [])
        }
        ...
        function _() {
            L.forEach(function(t) {
                var e = t.eventType,
                    t = t.handler;
                F.reference.removeEventListener(e, t)
            })
        }

        function w() {
            clearTimeout(D), clearTimeout(P)
        }
        ...
        function x() {
            ...
            Qt(e, q);
            var t = F.props,
                i = Gt(F.reference, j({}, F.props, e, {
                    performance: !0
                }));
            i.performance = (e.hasOwnProperty("performance") ? e : t).performance, F.props = i, (e.hasOwnProperty("trigger") || e.hasOwnProperty("touchHold")) && (_(), y()), e.hasOwnProperty("interactiveDebounce") && (r(), H = Kt(h, e.interactiveDebounce)), Lt(F.popper, t, i), F.popperChildren = Dt(F.popper), F.popperInstance && X.some(function(t) {
                return e.hasOwnProperty(t)
            }) && (F.popperInstance.destroy(), F.popperInstance = m(), F.state.isVisible || F.popperInstance.disableEventListeners(), F.props.followCursor && I && s(I))
        }

        function C() {
            var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : zt(F.props.duration, 0, q.duration[0]);
            return F.state.isDestroyed || !F.state.isEnabled || Zt && !F.props.touch ? void 0 : F.reference.isVirtual || document.documentElement.contains(F.reference) ? F.reference.hasAttribute("disabled") ? void 0 : A ? void(A = !1) : void(!1 === F.props.onShow(F) || (F.popper.style.visibility = "visible", F.state.isVisible = !0, It([F.popper, F.popperChildren.tooltip, F.popperChildren.backdrop], 0), function(t) {
                F.popperInstance ? g() || (F.popperInstance.scheduleUpdate(), F.props.livePlacement && F.popperInstance.enableEventListeners()) : (F.popperInstance = m(), F.props.livePlacement && !g() || F.popperInstance.disableEventListeners()), F.popperInstance.reference = F.reference;
                var e, i = F.popperChildren.arrow;
                g() ? (i && (i.style.margin = "0"), e = zt(F.props.delay, 0, q.delay), M.type && s(e && I ? I : M)) : i && (i.style.margin = ""), $t(F.popperInstance, t), F.props.appendTo.contains(F.popper) || (F.props.appendTo.appendChild(F.popper), F.props.onMount(F), F.state.isMounted = !0)
            }(function() {
                F.state.isVisible && (g() || F.popperInstance.update(), It([F.popperChildren.tooltip, F.popperChildren.backdrop, F.popperChildren.content], t), F.popperChildren.backdrop && (F.popperChildren.content.style.transitionDelay = Y(t / 6) + "ms"), F.props.interactive && F.reference.classList.add("tippy-active"), F.props.sticky && (It([F.popper], V ? 0 : F.props.updateDuration), function t() {
                    F.popperInstance && F.popperInstance.scheduleUpdate(), F.state.isMounted ? requestAnimationFrame(t) : It([F.popper], 0)
                }()), Yt([F.popperChildren.tooltip, F.popperChildren.backdrop, F.popperChildren.content], "visible"), v(t, function() {
                    0 === F.props.updateDuration && F.popperChildren.tooltip.classList.add("tippy-notransition"), F.props.interactive && -1 < ["focus", "click"].indexOf(M.type) && Wt(F.popper), F.reference.setAttribute("aria-describedby", F.popper.id), F.props.onShown(F), F.state.isShown = !0
                }))
            }))) : T()
        }

        function k() {
            var t, e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : zt(F.props.duration, 1, q.duration[1]);
            F.state.isDestroyed || !F.state.isEnabled || !1 === F.props.onHide(F) || (0 === F.props.updateDuration && F.popperChildren.tooltip.classList.remove("tippy-notransition"), F.props.interactive && F.reference.classList.remove("tippy-active"), F.popper.style.visibility = "hidden", F.state.isVisible = !1, F.state.isShown = !1, It([F.popperChildren.tooltip, F.popperChildren.backdrop, F.popperChildren.content], e), Yt([F.popperChildren.tooltip, F.popperChildren.backdrop, F.popperChildren.content], "hidden"), F.props.interactive && !A && -1 < ["focus", "click"].indexOf(M.type) && ("focus" === M.type && (A = !0), Wt(F.reference)), t = function() {
                z || o(), F.reference.removeAttribute("aria-describedby"), F.popperInstance.disableEventListeners(), F.props.appendTo.removeChild(F.popper), F.state.isMounted = !1, F.props.onHidden(F)
            }, v(e, function() {
                !F.state.isVisible && F.props.appendTo.contains(F.popper) && t()
            }))
        }

        function T(t) {
            F.state.isDestroyed || (F.state.isVisible && k(0), _(), F.reference.removeEventListener("click", i), delete F.reference._tippy, F.props.target && t && St(F.reference.querySelectorAll(F.props.target)).forEach(function(t) {
                return t._tippy && t._tippy.destroy()
            }), F.popperInstance && F.popperInstance.destroy(), S && S.disconnect(), F.state.isDestroyed = !0)
        }
        var E = Gt(t, e);
        ...
        var S = null,
            ...
            L = [],
            A = !1,
            H = 0 < E.interactiveDebounce ? Kt(h, E.interactiveDebounce) : h,
            N = ae++,
            W = Ot(N, E);
        W.addEventListener("mouseenter", function(t) {
            F.props.interactive && F.state.isVisible && "mouseenter" === M.type && n(t)
        }), W.addEventListener("mouseleave", function(t) {
            F.props.interactive && "mouseenter" === M.type && 0 === F.props.interactiveDebounce && qt(Vt(W), W.getBoundingClientRect(), t, F.props) && a()
        });
        var e = Dt(W),
            F = {
                id: N,
        ...
        return y(), t.addEventListener("click", i), E.lazy || (F.popperInstance = m(), F.popperInstance.disableEventListeners()), E.showOnInit && n(), !E.a11y || E.target || Mt(t) || t.setAttribute("tabindex", "0"), t._tippy = F, W._tippy = F
    }

    function L(t, e, i) {
        Qt(e, q), oe || (n = re, document.addEventListener("click", ie, n), document.addEventListener("touchstart", Jt, {
            passive: !0
        }), window.addEventListener("blur", se), window.addEventListener("resize", ne), U || !navigator.maxTouchPoints && !navigator.msMaxTouchPoints || document.addEventListener("pointerdown", Jt), oe = !0);
        var s = j({}, q, e);
        ft(t) && function(i) {
            var t = {
                    isVirtual: !0,
                    ...
                    getAttribute: function(t) {
                        return i.attributes[t]
                    },
                    removeAttribute: function(t) {
                        delete i.attributes[t]
                    },
                    hasAttribute: function(t) {
                        return t in i.attributes
                    },
                    addEventListener: function() {},
                    removeEventListener: function() {},
                    classList: {
                        classNames: {},
                        add: function(t) {
                            i.classList.classNames[t] = !0
                        },
                        remove: function(t) {
                            delete i.classList.classNames[t]
                        },
                        contains: function(t) {
                            return t in i.classList.classNames
                        }
                    }
                },
                e;
        ...
        var n = function(t) {
                if (t instanceof Element || ft(t)) return [t];
    ...
    for (var B = Math.min, Y = Math.round, A = Math.floor, $ = Math.max, j = Object.assign || function(t) {
            ...
            wait: null,
            zIndex: 9999
        }, X = ["arrowType", "distance", "flip", "flipBehavior", "offset", "placement", "popperOptions"], H = "undefined" != typeof window, N = H ? navigator : {}, W = H ? window : {}, F = ("MutationObserver" in W), V = /MSIE |Trident\//.test(N.userAgent), G = /iPhone|iPad|iPod/.test(N.platform) && !W.MSStream, U = ("ontouchstart" in W), K = "undefined" != typeof window && "undefined" != typeof document, Q = ["Edge", "Trident", "Firefox"], Z = 0, J = 0; J < Q.length; J += 1)
    ...
    var et = K && window.Promise ? function(t) {
            var e = !1;
            return function() {
        ...
        it = K && !(!window.MSInputMethodContext || !document.documentMode),
        st = K && /MSIE 10/.test(navigator.userAgent),
        nt = function(t, e) {
            ...
            value: function() {
                return function() {
                    ...
                    this.state.isDestroyed || ((t = {
                        ...
                        flipped: !1,
                        offsets: {}
                    }).offsets.reference = l(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = r(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = k(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = E(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t)))
                }.call(this)
            }
        }, {
            key: "destroy",
    ...
    function dt(t, e) {
        ...
        nt(this, dt), this.scheduleUpdate = function() {
            return requestAnimationFrame(i.update)
        }, this.update = et(this.update.bind(this)), this.options = at({}, dt.Defaults, s), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(at({}, dt.Defaults.modifiers, s.modifiers)).forEach(function(t) {
            i.options.modifiers[t] = at({}, dt.Defaults.modifiers[t] || {}, s.modifiers ? s.modifiers[t] : {})
    ...
    ct.Utils = ("undefined" == typeof window ? global : window).PopperUtils, ct.placements = W, ct.Defaults = {
        placement: "bottom",
        positionFixed: !1,
        eventsEnabled: !0,
        removeOnDestroy: !1,
        ...
        modifiers: {
            shift: {
                ...
                fn: function(t) {
                    ...
                    return a && (e = (i = t.offsets).reference, s = i.popper, n = (i = -1 !== ["bottom", "top"].indexOf(n)) ? "width" : "height", n = {
                        start: tt({}, i = i ? "left" : "top", e[i]),
                        end: tt({}, i, e[i] + e[n] - s[n])
                    }, t.offsets.popper = at({}, s, n[a])), t
                }
            },
            offset: {
                order: 200,
                ...
                fn: function(t, e) {
                    var i = e.offset,
                        s = t.placement,
                        n = (a = t.offsets).popper,
                        e = a.reference,
                        a = s.split("-")[0],
                        s = void 0,
                        s = I(+i) ? [+i, 0] : O(i, n, e, a);
                    return "left" === a ? (n.top += s[0], n.left -= s[1]) : "right" === a ? (n.top += s[0], n.left += s[1]) : "top" === a ? (n.left += s[0], n.top -= s[1]) : "bottom" === a && (n.left += s[0], n.top += s[1]), t.popper = n, t
                },
                offset: 0
            },
            preventOverflow: {
                ...
                fn: function(t, s) {
                    ...
                    var i = S("transform"),
                        ...
                        r = n[i];
                    n.top = "", n.left = "", n[i] = "";
                    var l = w(t.instance.popper, t.instance.reference, s.padding, e, t.positionFixed);
                    ...
                    var r = s.priority,
                        ...
                        c = {
                            primary: function(t) {
                                var e = h[t];
                                return h[t] < l[t] && !s.escapeWithReference && (e = $(h[t], l[t])), tt({}, t, e)
                            },
                            secondary: function(t) {
                                var e = "right" === t ? "left" : "top",
                                    i = h[e];
                                return h[t] > l[t] && !s.escapeWithReference && (i = B(h[e], l[t] - ("right" === t ? h.width : h.height))), tt({}, e, i)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    var s = t.placement.split("-")[0],
                        ...
                        n = r ? "bottom" : "right",
                        s = x(i)[l];
                    o[n] - s < a[c] && (t.offsets.popper[c] -= a[c] - (o[n] - s)), o[c] + s > a[n] && (t.offsets.popper[c] += o[c] + s - a[n]), t.offsets.popper = v(t.offsets.popper);
                    r = o[c] + o[l] / 2 - s / 2, n = d(t.instance.popper), o = parseFloat(n["margin" + h], 10), h = parseFloat(n["border" + h + "Width"], 10), h = r - t.offsets.popper[c] - o - h, h = $(B(a[l] - s, h), 0);
                    return t.arrowElement = i, t.offsets.arrow = (tt(i = {}, c, Y(h)), tt(i, e, ""), i), t
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(l, h) {
                    ...
                    var c = w(l.instance.popper, l.instance.reference, h.padding, h.boundariesElement, l.positionFixed),
                    ...
                    return f.forEach(function(t, e) {
                        if (d !== t || f.length === e + 1) return l;
                        d = l.placement.split("-")[0], u = C(d);
                        var i = l.offsets.popper,
                            s = l.offsets.reference,
                            n = A,
                            a = "left" === d && n(i.right) > n(s.left) || "right" === d && n(i.left) < n(s.right) || "top" === d && n(i.bottom) > n(s.top) || "bottom" === d && n(i.top) < n(s.bottom),
                            o = n(i.left) < n(c.left),
                            r = n(i.right) > n(c.right),
                            t = n(i.top) < n(c.top),
                            s = n(i.bottom) > n(c.bottom),
                            i = "left" === d && o || "right" === d && r || "top" === d && t || "bottom" === d && s,
                            n = -1 !== ["top", "bottom"].indexOf(d),
                            s = !!h.flipVariations && (n && "start" === p && o || n && "end" === p && r || !n && "start" === p && t || !n && "end" === p && s);
                        (a || i || s) && (l.flipped = !0, (a || i) && (d = f[e + 1]), s && (p = "end" === (s = p) ? "start" : "start" === s ? "end" : s), l.placement = d + (p ? "-" + p : ""), l.offsets.popper = at({}, l.offsets.popper, k(l.instance.popper, l.offsets.reference, l.placement)), l = E(l.instance.modifiers, l, "flip"))
                    }), l
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(t) {
                    ...
                    return n[o ? "left" : "top"] = a[i] - (s ? n[o ? "width" : "height"] : 0), t.placement = C(e), t.offsets.popper = v(n), t
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var o = void 0 === a ? e.gpuAcceleration : a,
                        ...
                        n = S("transform"),
                        s = "bottom" == e ? "HTML" === r.nodeName ? -r.clientHeight + c.bottom : -l.height + c.bottom : c.top,
                        i = "right" == a ? "HTML" === r.nodeName ? -r.clientWidth + c.right : -l.width + c.right : c.left;
                    o && n ? (h[n] = "translate3d(" + i + "px, " + s + "px, 0)", h[e] = 0, h[a] = 0, h.willChange = "transform") : (n = "right" == a ? -1 : 1, h[e] = s * ("bottom" == e ? -1 : 1), h[a] = i * n, h.willChange = e + ", " + a);
                    a = {
                        "x-placement": t.placement
                    };
                    return t.attributes = at({}, a, t.attributes), t.styles = at({}, h, t.styles), t.arrowStyles = at({}, t.offsets.arrow, t.arrowStyles), t
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
            ...
            applyStyle: {
                ...
                onLoad: function(t, e, i, s, n) {
                    n = l(n, e, t, i.positionFixed), t = r(i.placement, n, e, t, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
                    return e.setAttribute("x-placement", t), D(e, {
    ...
    function pt(t, e) {
        e.content instanceof Element ? (Pt(t, ""), t.appendChild(e.content)) : t[e.allowHTML ? "innerHTML" : "textContent"] = e.content
    }
    ...
    function gt(t) {
        var e = mt();
        return "round" === t ? (e.className = "tippy-roundarrow", Pt(e, '<svg viewBox="0 0 24 8" xmlns="http://www.w3.org/2000/svg"><path d="M3 8s2.021-.015 5.253-4.218C9.584 2.051 10.797 1.007 12 1c1.203-.007 2.416 1.035 3.761 2.782C19.012 8.005 21 8 21 8H3z"/></svg>')) : e.className = "tippy-arrow", e
    }
    ...
    function yt(i) {
        St(document.querySelectorAll(Tt.POPPER)).forEach(function(t) {
            var e = t._tippy;
            !e || !0 !== e.props.hideOnClick || i && t === i.popper || e.hide()
        })
    }

    function _t(s) {
        return Object.keys(q).reduce(function(t, e) {
            var i = (s.getAttribute("data-tippy-" + e) || "").trim();
            return i && (t[e] = "content" === e ? i : "true" === i || "false" !== i && (e = i, isNaN(e) || isNaN(parseFloat(e)) ? "[" === i[0] || "{" === i[0] ? JSON.parse(i) : i : +i)), t
        }, {})
    }
    ...
    function xt(t, e, i, s) {
        ...
        return n || e ? {
            scale: e ? i ? n + ", " + e : e + ", " + n : "" + n,
            translate: e ? i ? s ? n + "px, " + -e + "px" : n + "px, " + e + "px" : s ? -e + "px, " + n + "px" : e + "px, " + n + "px" : s ? -n + "px" : n + "px"
        } [t] : ""
    }

    function Ct(t, e) {
        return (e = t.match(new RegExp(e + "([XY])"))) ? e[1] : ""
    }

    function kt(t, e) {
        return (e = t.match(e)) ? e[1].split(",").map(parseFloat) : []
    }
    var Tt = {
            POPPER: ".tippy-popper",
        ...
        Mt = function(t) {
            return !(t instanceof Element) || At.call(t, "a[href],area[href],button,details,input,textarea,select,iframe,[tabindex]") && !t.hasAttribute("disabled")
        },
        It = function(t, e) {
        ...
        Ot = function(t, e) {
            ...
            var s = mt();
            s.className = "tippy-tooltip", s.setAttribute("data-size", e.size), s.setAttribute("data-animation", e.animation), s.setAttribute("data-state", "hidden"), e.theme.split(" ").forEach(function(t) {
                s.classList.add(t + "-theme")
            });
            t = mt();
            return t.className = "tippy-content", t.setAttribute("data-state", "hidden"), e.interactive && bt(i, s), e.arrow && s.appendChild(gt(e.arrowType)), e.animateFill && (s.appendChild(vt()), s.setAttribute("data-animatefill", "")), e.inertia && s.setAttribute("data-inertia", ""), pt(t, e), s.appendChild(t), i.appendChild(s), i.addEventListener("focusout", function(t) {
                t.relatedTarget && i._tippy && !Nt(t.relatedTarget, function(t) {
                    return t === i
                }) && t.relatedTarget !== i._tippy.reference && i._tippy.props.shouldPopperHideOnBlur(t) && i._tippy.hide()
            }), i
        },
        Lt = function(t, e, i) {
            var s = Dt(t),
                ...
                o = s.backdrop,
                s = s.arrow;
            t.style.zIndex = i.zIndex, n.setAttribute("data-size", i.size), n.setAttribute("data-animation", i.animation), e.content !== i.content && pt(a, i), !e.animateFill && i.animateFill ? (n.appendChild(vt()), n.setAttribute("data-animatefill", "")) : e.animateFill && !i.animateFill && (n.removeChild(o), n.removeAttribute("data-animatefill")), !e.arrow && i.arrow ? n.appendChild(gt(i.arrowType)) : e.arrow && !i.arrow && n.removeChild(s), e.arrow && i.arrow && e.arrowType !== i.arrowType && n.replaceChild(gt(i.arrowType), s), !e.interactive && i.interactive ? bt(t, n) : e.interactive && !i.interactive && (s = n, t.removeAttribute("tabindex"), s.removeAttribute("data-interactive")), !e.inertia && i.inertia ? n.setAttribute("data-inertia", "") : e.inertia && !i.inertia && n.removeAttribute("data-inertia"), e.theme !== i.theme && (e.theme.split(" ").forEach(function(t) {
                n.classList.remove(t + "-theme")
            }), i.theme.split(" ").forEach(function(t) {
                n.classList.add(t + "-theme")
            }))
        },
        At = function() {
            if (H) {
        ...
        Bt = function(t, e) {
            var i = Vt(Ht(t, Tt.POPPER)),
                ...
                n = e.replace(Ft, "translate" + wt(i.translate.axis, s) + "(" + xt("translate", i.translate.numbers, s, n) + ")").replace(Rt, "scale" + wt(i.scale.axis, s) + "(" + xt("scale", i.scale.numbers, s, n) + ")");
            t.style[void 0 === document.body.style.transform ? "webkitTransform" : "transform"] = n
        },
        Yt = function(t, e) {
            t.filter(Boolean).forEach(function(t) {
        ...
        $t = function(t, e) {
            var i = t.popper,
                ...
                n = s.onCreate,
                a = s.onUpdate;
            s.onCreate = s.onUpdate = function() {
                i.offsetHeight, e(), a(), s.onCreate = n, s.onUpdate = a
            }
        },
        jt = function(t) {
            setTimeout(t, 1)
        ...
        qt = function(t, e, i, s) {
            ...
            var n = i.clientX,
                a = i.clientY,
                o = s.interactiveBorder,
                r = s.distance,
                i = e.top - a > ("top" === t ? o + r : o),
                s = a - e.bottom > ("bottom" === t ? o + r : o),
                a = e.left - n > ("left" === t ? o + r : o),
                o = n - e.right > ("right" === t ? o + r : o);
            return i || s || a || o
        },
        Xt = function(t, e) {
            return -(t - e) + "px"
        ...
        Vt = function(t) {
            t = t.getAttribute("x-placement");
            return t ? t.split("-")[0] : ""
        },
        Gt = function(t, e) {
            var i = j({}, e, e.performance ? {} : _t(t));
            return i.arrow && (i.animateFill = !1), "function" == typeof i.appendTo && (i.appendTo = e.appendTo(t)), "function" == typeof i.content && (i.content = e.content(t)), i
        },
        Ut = function(t, e, i) {
            t[e + "EventListener"]("transitionend", i)
        },
        Kt = function(i, s) {
            var n;
            return function() {
        ...
        Qt = function(t, e) {
            for (var i in t || {})
                if (!(i in e)) throw Error("[tippy]: `" + i + "` is not a valid option")
        },
        Zt = !1,
        Jt = function() {
            Zt || (Zt = !0, G && document.body.classList.add("tippy-iOS"), window.performance && document.addEventListener("mousemove", ee))
        },
        te = 0,
        ee = function t() {
            var e = performance.now();
            e - te < 20 && (Zt = !1, document.removeEventListener("mousemove", t), G || document.body.classList.remove("tippy-iOS")), te = e
        },
        ie = function(t) {
            var e = t.target;
            ...
            if (!(t && t._tippy && t._tippy.props.interactive)) {
                ...
                if (t) {
                    e = t._tippy, t = -1 < e.props.trigger.indexOf("click");
                    if (Zt || t) return yt(e);
                    if (!0 !== e.props.hideOnClick || t) return;
        ...
        oe = !1,
        re = !1;
    return L.version = "3.1.3", L.defaults = q, L.one = function(t, e) {
        return L(t, e, !0).instances[0]
    }, L.setDefaults = function(t) {
        q = j({}, q, t), L.defaults = q
    ...
    }, L.hideAllPoppers = yt, L.useCapture = function() {
        re = !0
...
function() {
    ...
    var s, t, i, l, n, o = [].indexOf || function(t) {
    ...
    c.prototype.extend = function(t, e) {
        ...
        for (var i, s = this.keys, n = i = 0, a = s.length; i < a; n = ++i)
        ...
        return this.getPropertyValue = function(t) {
            var e;
            return n.test(t = "float" === t ? "styleFloat" : t) && t.replace(n, function(t, e) {
                return e.toUpperCase()
            }), (null != (e = i.currentStyle) ? e[t] : void 0) || null
        }, this
    }, n = /(\-([a-z]){1})/g, this.WOW = (a.prototype.defaults = {
        boxClass: "wow",
        ...
        return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new s((o = this, function(t) {
            for (var n, a, e = [], i = 0, s = t.length; i < s; i++) a = t[i], e.push(function() {
                for (var t = a.addedNodes || [], e = [], i = 0, s = t.length; i < s; i++) n = t[i], e.push(this.doSync(n));
                return e
            }.call(o));
            return e
        ...
        if (1 === (t = null == t ? this.element : t).nodeType) {
            for (a = [], i = 0, s = (n = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; i < s; i++) e = n[i], o.call(this.all, e) < 0 ? (this.boxes.push(e), this.all.push(e), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(e, !0), a.push(this.scrolled = !0)) : a.push(void 0);
            return a
        }
        ...
        return this.animate((i = this, function() {
            return i.customStyle(t, e, s, n, a)
        }))
    ...
    }, a.prototype.customStyle = function(t, e, i, s, n) {
    ...
    }, a.prototype.vendors = ["moz", "webkit"], a.prototype.vendorSet = function(n, t) {
        var a, o, r, e = [];
        for (a in t) o = t[a], n["" + a] = o, e.push(function() {
            for (var t = this.vendors, e = [], i = 0, s = t.length; i < s; i++) r = t[i], e.push(n["" + r + a.charAt(0).toUpperCase() + a.substr(1)] = o);
            return e
        }.call(this));
        return e
    }, a.prototype.vendorCSS = function(t, e) {
        for (var i, s = l(t), n = s.getPropertyCSSValue(e), a = this.vendors, o = 0, r = a.length; o < r; o++) i = a[o], n = n || s.getPropertyCSSValue("-" + i + "-" + e);
        return n
